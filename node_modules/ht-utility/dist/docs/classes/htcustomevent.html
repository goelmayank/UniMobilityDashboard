...
<head>
	...
	<title>HtCustomEvent | ht-utility</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class">
			<a href="htcustomevent.html" class="tsd-kind-icon">Ht<wbr>Custom<wbr>Event</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private">
					<a href="htcustomevent.html#hop" class="tsd-kind-icon">hOP</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private">
					<a href="htcustomevent.html#topics" class="tsd-kind-icon">topics</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="htcustomevent.html#next" class="tsd-kind-icon">next</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="htcustomevent.html#subscribe" class="tsd-kind-icon">subscribe</a>
				</li>
			</ul>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">HtCustomEvent</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-private tsd-is-private-protected">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private"><a href="htcustomevent.html#hop" class="tsd-kind-icon">hOP</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private"><a href="htcustomevent.html#topics" class="tsd-kind-icon">topics</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="htcustomevent.html#next" class="tsd-kind-icon">next</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="htcustomevent.html#subscribe" class="tsd-kind-icon">subscribe</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-private tsd-is-private-protected">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
				<a name="hop" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> hOP</h3>
				<div class="tsd-signature tsd-kind-icon">hOP<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">hasOwnProperty</span><span class="tsd-signature-symbol"> =&nbsp;this.topics.hasOwnProperty</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/e6481168/packages/utils/src/custom-events.ts#L3">custom-events.ts:3</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private">
				<a name="topics" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> topics</h3>
				<div class="tsd-signature tsd-kind-icon">topics<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/e6481168/packages/utils/src/custom-events.ts#L2">custom-events.ts:2</a></li>
					</ul>
				</aside>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">next<span class="tsd-signature-symbol">(</span>topic<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, info<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/e6481168/packages/utils/src/custom-events.ts#L5">custom-events.ts:5</a></li>
							</ul>
						</aside>
						...
						<ul class="tsd-parameters">
							...
							<li>
								<h5>info: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3>subscribe</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">subscribe<span class="tsd-signature-symbol">(</span>topic<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, listener<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/ieventsub.html" class="tsd-signature-type">IEventSub</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/e6481168/packages/utils/src/custom-events.ts#L15">custom-events.ts:15</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
						...
						<h4 class="tsd-returns-title">Returns <a href="../interfaces/ieventsub.html" class="tsd-signature-type">IEventSub</a></h4>
					</li>
				</ul>
			</section>
		</section>
