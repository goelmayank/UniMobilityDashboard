(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('date-fns'), require('jstz')) :
	typeof define === 'function' && define.amd ? define(['exports', 'date-fns', 'jstz'], factory) :
	(factory((global.htUtility = {}),global.dateFns,global.jstz));
}(this, (function (exports,dateFns,jstz) { 'use strict';
...
function DateHumanize(value, arg) {
    ...
    if (typeof value == "string" && value.length > 4 && dateFns.isValid(new Date(value))) {
        ...
        if (dateFns.isToday(date)) {
            ...
            return dateFns.format(date, "D MMM");
        }
    }
    else {
        return value;
...
function DateString(item, args) {
    if (typeof item == "string" && item.length > 4 && dateFns.isValid(new Date(item))) {
        var formatString = args == "short" ? "MMM D" : "MMM D, YYYY";
        return dateFns.format(new Date(item), formatString);
    }
    else {
        return item;
    }
...
function TimeString(item, args) {
    if (typeof item == "string" && item.length > 4) {
        return dateFns.format(getNearestMinute(item), "h:mm a");
...
function OffsetIsoTime(time, offset) {
    ...
    return dateFns.addMilliseconds(time, offset).toISOString();
}
...
function HasSameMinute(time1, time2) {
    return dateFns.isSameMinute(time1, time2);
}
...
function isSameRange(range1, range2) {
    ...
    return dateFns.isSameDay(start1, start2) && dateFns.isSameDay(range1.end, range2.end);
}
function IsRangeToday(range) {
    if (range.start && range.end) {
        return range.start == dateFns.startOfToday().toISOString() && range.end == dateFns.endOfToday().toISOString();
    }
...
function IsRangeADay(range) {
    if (range.start && range.end) {
        return dateFns.isSameDay(range.end, range.start);
...
function RangeHasToday(query) {
    if (query.end) {
        return query.end == dateFns.endOfToday().toISOString();
    }
    else {
        return true;
    }
...
exports.AuthLessReqOptions = AuthLessReqOptions;
exports.ArrayHumanize = ArrayHumanize;
exports.indexBy = indexBy;
exports.Color = Color;
exports.COUNTRIES = COUNTRIES;
exports.DateHumanize = DateHumanize;
exports.DistanceLocale = DistanceLocale;
exports.DotString = DotString;
exports.HMString = HMString;
exports.HtShow = HtShow;
exports.NameCase = NameCase;
exports.TimeString = TimeString;
exports.OffsetIsoTime = OffsetIsoTime;
exports.GetMinute = GetMinute;
exports.HasSameMinute = HasSameMinute;
...
exports.HtQuerySerialize = HtQuerySerialize;
exports.GetUrlParam = GetUrlParam;
exports.HtCustomEvent = HtCustomEvent;
exports.getTimezone = getTimezone;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ht-utility_browser.js.map
