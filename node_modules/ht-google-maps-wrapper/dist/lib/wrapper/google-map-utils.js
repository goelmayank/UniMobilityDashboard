...
var light_color_map_1 = require("./light-color-map");
...
var GoogleMapUtilsClass = (function () {
    function GoogleMapUtilsClass() {
        ...
        this.defaultMapOptions = {
            ...
            styles: light_color_map_1.LightColorMapStyle
        };
    ...
    GoogleMapUtilsClass.prototype.setMap = function (item, map) {
        if (!map) {
            item.setMap(null);
        }
    ...
    GoogleMapUtilsClass.prototype.openPopup = function (item, map, content, popup) {
        if (popup) {
    ...
    GoogleMapUtilsClass.prototype.setFocus = function (item, map, _a) {
    ...
    GoogleMapUtilsClass.prototype.getMarkerCluster = function (map) {
        // console.log("get", map);
    ...
    GoogleMapUtilsClass.prototype.addMarkersToCluster = function (cluster, markers, map) {
    ...
    GoogleMapUtilsClass.prototype.setBounds = function (map, bounds, padding) {
    ...
    GoogleMapUtilsClass.prototype.invalidateSize = function (map) {
    ...
    GoogleMapUtilsClass.prototype.openPopupPosition = function (position, map, content, popup) {
        popup.setContent(content);
...
exports.GoogleMapUtilsClass = GoogleMapUtilsClass;
//# sourceMappingURL=google-map-utils.js.map