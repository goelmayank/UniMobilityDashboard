(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ht-utility'), require('rxjs/observable/fromPromise'), require('rxjs/operators'), require('rxjs/observable/empty')) :
	typeof define === 'function' && define.amd ? define(['exports', 'ht-utility', 'rxjs/observable/fromPromise', 'rxjs/operators', 'rxjs/observable/empty'], factory) :
	(factory((global.htApi = {}),global.htUtility,global.Rx.Observable,global.Rx.operators,global.Rx.Observable));
}(this, (function (exports,htUtility,fromPromise,operators,empty) { 'use strict';
...
var HtBaseApi = (function () {
    ...
    HtBaseApi.prototype.allPages = function (api$, options) {
        ...
        return api$.pipe(operators.expand(function (data) {
            return data["next"]
                ? _this.request.api$(data["next"], {}, __assign$1({}, options, { pureUrl: true })).pipe(operators.map(function (newData) {
...
exports.htRequestService = htRequestService;
exports.HtApi = HtApi;
exports.HtRequest = HtRequest;
exports.HtToken = HtToken;
exports.HtAccountUserApi = HtAccountUserApi;
exports.HtActionsApi = HtActionsApi;
exports.htActionsApi = htActionsApi;
exports.HtGroupsApi = HtGroupsApi;
exports.HtUsersApi = HtUsersApi;
