(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet'), require('leaflet.markercluster'), require('leaflet.heat'), require('rxjs/observable/fromEventPattern')) :
	typeof define === 'function' && define.amd ? define(['exports', 'leaflet', 'leaflet.markercluster', 'leaflet.heat', 'rxjs/observable/fromEventPattern'], factory) :
	(factory((global.htLeafletWrapper = {}),global.L,global.L,global.L,global.Rx.Observable));
}(this, (function (exports,L,leaflet_markercluster,leaflet_heat,fromEventPattern) { 'use strict';
...
var LeafletMapUtilsClass = (function () {
    ...
    LeafletMapUtilsClass.prototype.renderMap = function (elem, options) {
        ...
        var newmap = L.map(elem, options);
        if (options.tileLayerUrl) {
            L.tileLayer(options.tileLayerUrl, options.tileLayerOptions || {}).addTo(newmap);
        }
        return newmap;
    };
...
exports.PolylineUtil = PolylineUtil;
exports.markerCluster = markerCluster;
exports.leafletHeat = leafletHeat;
