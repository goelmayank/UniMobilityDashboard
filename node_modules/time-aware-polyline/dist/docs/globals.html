...
<head>
	...
	<title>time-aware-polyline | time-aware-polyline</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-class">
			<a href="classes/polylineutils.html" class="tsd-kind-icon">Polyline<wbr>Utils</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/timeawareanimation.html" class="tsd-kind-icon">Time<wbr>Aware<wbr>Animation</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/timeawareencoder.html" class="tsd-kind-icon">Time<wbr>Aware<wbr>Encoder</a>
		</li>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="time-aware-polylines-in-javascript">Time aware polylines in javascript</h1>
			<p>The google encoded <a href="https://developers.google.com/maps/documentation/utilities/polylinealgorithm">polyline algorithm</a> converts location coordinates into an ascii string. We have extended the algorithm to convert location coordinates with time stamps into ascii strings. The time aware polyline is also available in <a href="https://github.com/hypertrack/time-aware-polyline-py">python</a>.</p>
			<p><a href="https://badge.fury.io/js/time-aware-polyline"><img src="https://badge.fury.io/js/time-aware-polyline.svg" alt="npm version"></a> <a href="https://travis-ci.org/hypertrack/time-aware-polyline-js"><img src="https://travis-ci.org/hypertrack/time-aware-polyline-js.svg?branch=master" alt="Build Status"></a> <a href="https://coveralls.io/github/hypertrack/time-aware-polyline-js?branch=master"><img src="https://coveralls.io/repos/github/hypertrack/time-aware-polyline-js/badge.svg?branch=master" alt="Coverage Status"></a></p>
			<p>Time aware polylines can be used to mark time events on polylines, or run a trip replay, like in the <a href="https://dashboard.hypertrack.io/demo">HyperTrack dashboard</a>.</p>
			<p><img src="https://bloghypertrack.files.wordpress.com/2016/08/xa95zckcqb.gif?w=760" alt="Polyline with events"></p>
			<h2 id="install">Install</h2>
			<pre><code><span class="hljs-meta">$</span><span class="bash"> npm i time-aware-polyline</span>
</code></pre><h2 id="encoder">Encoder</h2>
			<pre><code class="lang-javascript"><span class="hljs-keyword">var</span> polylineUtil = <span class="hljs-built_in">require</span>(<span class="hljs-string">'time-aware-polyline'</span>);

<span class="hljs-keyword">var</span> points = [
    [<span class="hljs-number">19.13626</span>, <span class="hljs-number">72.92506</span>, <span class="hljs-string">'2016-07-21T05:43:09+00:00'</span>],
    [<span class="hljs-number">19.13597</span>, <span class="hljs-number">72.92495</span>, <span class="hljs-string">'2016-07-21T05:43:15+00:00'</span>],
    [<span class="hljs-number">19.13553</span>, <span class="hljs-number">72.92469</span>, <span class="hljs-string">'2016-07-21T05:43:21+00:00'</span>]
]
...
<span class="hljs-keyword">var</span> polyline = <span class="hljs-string">'spxsBsdb|Lymo`qvAx@TKvAr@K'</span>;
polylineUtil.decodeTimeAwarePolyline(polyline);
</code></pre>
			<h2 id="testing">Testing</h2>
			<p>To run the tests, you will need to install npm. Use the following command to run the tests.</p>
			<pre><code><span class="hljs-meta">$</span><span class="bash"> npm <span class="hljs-built_in">test</span></span>
</code></pre>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class"><a href="classes/polylineutils.html" class="tsd-kind-icon">Polyline<wbr>Utils</a></li>
							<li class="tsd-kind-class"><a href="classes/timeawareanimation.html" class="tsd-kind-icon">Time<wbr>Aware<wbr>Animation</a></li>
							<li class="tsd-kind-class"><a href="classes/timeawareencoder.html" class="tsd-kind-icon">Time<wbr>Aware<wbr>Encoder</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Variables</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable"><a href="globals.html#earth_radius" class="tsd-kind-icon">EARTH_<wbr>RADIUS</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable">
				<a name="earth_radius" class="tsd-anchor"></a>
				<h3>EARTH_<wbr>RADIUS</h3>
				<div class="tsd-signature tsd-kind-icon">EARTH_<wbr>RADIUS<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">6371</span><span class="tsd-signature-symbol"> =&nbsp;6371</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/caf8b9b/packages/time-aware-polyline/src/time-aware.ts#L394">time-aware.ts:394</a></li>
					</ul>
				</aside>
			</section>
		</section>
