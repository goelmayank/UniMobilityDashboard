...
var TimeAwarePolyline = (function () {
    ...
    TimeAwarePolyline.prototype.encodeTimeAwarePolyline = function (points) {
        return this.extendTimeAwarePolyline("", points, null);
    };
    TimeAwarePolyline.prototype.decodeTimeAwarePolyline = function (polyline) {
    ...
    TimeAwarePolyline.prototype.getLocationsAtTimestamps = function (decodedTimeAwarePolyline, timeStamps) {
    ...
    TimeAwarePolyline.prototype.getLocationsElapsedByTimestamp = function (decodedTimeAwarePolyline, timeStamp) {
    ...
    TimeAwarePolyline.prototype.getPolylineSegmentsPublic = function (decodedTimeAwarePolyline) {
    ...
    TimeAwarePolyline.prototype.getPolylineSegmentsForLocationsElapsed = function (decodedTimeAwarePolyline, timeStamp) {
    ...
    Other
     */
    TimeAwarePolyline.prototype.getLocationsTillTimeStamp = function (decodedPolyline, timeStamp) {
    ...
    TimeAwarePolyline.prototype.isDifferentSegment = function (end, start) {
        // function to determine whether a encoder
        // segment split should happen
        var distance = this.getDistance(start, end);
        return distance > 500;
    };
    TimeAwarePolyline.prototype.getPolylineSegments = function (decoded, timeLimit) {
    ...
    TimeAwarePolyline.prototype.updateBearing = function (oldBearing, gpxPair) {
    ...
    TimeAwarePolyline.prototype.getLocationInPair = function (gpxPair, timeStamp) {
    ...
    TimeAwarePolyline.prototype.getNextLatLng = function (decoded, timeStamp) {
    ...
    TimeAwarePolyline.prototype.getDistance = function (origin, destination) {
    ...
    TimeAwarePolyline.prototype.toRadian = function (degree) {
        return degree * Math.PI / 180;
    };
    TimeAwarePolyline.prototype.computeHeading = function (start, end) {
    ...
    TimeAwarePolyline.prototype.areEqualLatlngs = function (latlngA, latlngB) {
        return (latlngA[0] == latlngB[0]) && (latlngA[1] == latlngB[1]);
    };
    TimeAwarePolyline.prototype.removeTimeStamps = function (segment) {
        var result = [];
    ...
    Helpers
     */
    TimeAwarePolyline.prototype.getDecodedDimensionFromPolyline = function (polyline, index) {
    ...
    TimeAwarePolyline.prototype.extendTimeAwarePolyline = function (polyline, points, lastPoint) {
    ...
    TimeAwarePolyline.prototype.getCoordinate = function (intRepresentation) {
        var coordinate = intRepresentation * 0.00001;
        return +coordinate.toFixed(5);
    };
    TimeAwarePolyline.prototype.getIsoTime = function (timeStamp) {
        // timeStamp is in seconds
        return new Date(timeStamp * 1000).toISOString();
    };
    TimeAwarePolyline.prototype.getGpxLog = function (lat, lng, timeStamp) {
        return [
            this.getCoordinate(lat), this.getCoordinate(lng), this.getIsoTime(timeStamp)
        ];
    };
    TimeAwarePolyline.prototype.getLat = function (gpxLog) {
        return Math.round(gpxLog[0] * 100000);
    };
    TimeAwarePolyline.prototype.getLng = function (gpxLog) {
        return Math.round(gpxLog[1] * 100000);
    };
    TimeAwarePolyline.prototype.getTimeStamp = function (gpxLog) {
        return +new Date(gpxLog[2]) / 1000;
    };
    TimeAwarePolyline.prototype.lshiftOperator = function (num, bits) {
        // Custom left shift for 64 bit integers
        return num * Math.pow(2, bits);
    };
    TimeAwarePolyline.prototype.rshiftOperator = function (num, bits) {
        // Custom right shift for 64 bit integers
        return Math.floor(num / Math.pow(2, bits));
    };
    TimeAwarePolyline.prototype.notOperator = function (num) {
        // Custom not operator for 64 bit integers
        return ~num;
    };
    return TimeAwarePolyline;
}());
export { TimeAwarePolyline };
;
export var EARTH_RADIUS = 6371;
//# sourceMappingURL=time-aware-encoder.js.map