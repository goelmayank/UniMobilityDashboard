		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">ht-data</a></strong>
				</div>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-class">
			<a href="classes/htaction.html" class="tsd-kind-icon">Ht<wbr>Action</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/htevent.html" class="tsd-kind-icon">Ht<wbr>Event</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/htplaceline.html" class="tsd-kind-icon">Ht<wbr>Placeline</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/htstop.html" class="tsd-kind-icon">Ht<wbr>Stop</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="classes/htuser.html" class="tsd-kind-icon">Ht<wbr>User</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/data.html" class="tsd-kind-icon">Data</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/htposition.html" class="tsd-kind-icon">Ht<wbr>Position</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/iactionmark.html" class="tsd-kind-icon">IAction<wbr>Mark</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/iactionpositions.html" class="tsd-kind-icon">IAction<wbr>Positions</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/iactivitysegment.html" class="tsd-kind-icon">IActivity<wbr>Segment</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/iallowedquerymap.html" class="tsd-kind-icon">IAllowed<wbr>Query<wbr>Map</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/ieventdisplay.html" class="tsd-kind-icon">IEvent<wbr>Display</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/ieventmark.html" class="tsd-kind-icon">IEvent<wbr>Mark</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/iplacelinesegment.html" class="tsd-kind-icon">IPlaceline<wbr>Segment</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/iprocsegment.html" class="tsd-kind-icon">IProc<wbr>Segment</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/ireplaysegment.html" class="tsd-kind-icon">IReplay<wbr>Segment</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/isegmentstyle.html" class="tsd-kind-icon">ISegment<wbr>Style</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/isegmenttype.html" class="tsd-kind-icon">ISegment<wbr>Type</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/itableformat.html" class="tsd-kind-icon">ITable<wbr>Format</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="interfaces/itableformatconfig.html" class="tsd-kind-icon">ITable<wbr>Format<wbr>Config</a>
		</li>
		<li class=" tsd-kind-variable">
			<a href="globals.html#datemapservice" class="tsd-kind-icon">Date<wbr>Map<wbr>Service</a>
		</li>
		<li class=" tsd-kind-variable">
			<a href="globals.html#daterangelabelmap" class="tsd-kind-icon">Date<wbr>Range<wbr>Label<wbr>Map</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#allowedquerykeys_" class="tsd-kind-icon">Allowed<wbr>Query<wbr>Keys$</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#allowedquerymap" class="tsd-kind-icon">Allowed<wbr>Query<wbr>Map</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#combineloadings_" class="tsd-kind-icon">Combine<wbr>Loadings$</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#combinequeries" class="tsd-kind-icon">Combine<wbr>Queries</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#daterangetoquery_" class="tsd-kind-icon">Date<wbr>Range<wbr>ToQuery$</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#getsecrettoken" class="tsd-kind-icon">Get<wbr>Secret<wbr>Token</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#iscurrentmember" class="tsd-kind-icon">Is<wbr>Current<wbr>Member</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#mergequery" class="tsd-kind-icon">Merge<wbr>Query</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#pageresults_" class="tsd-kind-icon">Page<wbr>Results$</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#updatesubaccountofaccount" class="tsd-kind-icon">Update<wbr>Sub<wbr>Account<wbr>OfAccount</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#andcombine" class="tsd-kind-icon">and<wbr>Combine</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#datawithselectedid_" class="tsd-kind-icon">data<wbr>With<wbr>Selected<wbr>Id$</a>
		</li>
		<li class=" tsd-kind-function tsd-is-not-exported">
			<a href="globals.html#datetimestring" class="tsd-kind-icon">date<wbr>Time<wbr>String</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#entitydatafactory" class="tsd-kind-icon">entity<wbr>Data<wbr>Factory</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#getaccountfromaccountuserid" class="tsd-kind-icon">get<wbr>Account<wbr>From<wbr>Account<wbr>User<wbr>Id</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#getauthheaders" class="tsd-kind-icon">get<wbr>Auth<wbr>Headers</a>
		</li>
		<li class=" tsd-kind-function tsd-is-not-exported">
			<a href="globals.html#getsubaccounttoken" class="tsd-kind-icon">get<wbr>Sub<wbr>Account<wbr>Token</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#gettoken" class="tsd-kind-icon">get<wbr>Token</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#htaction" class="tsd-kind-icon">ht<wbr>Action</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#htevent" class="tsd-kind-icon">ht<wbr>Event</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#htplaceline" class="tsd-kind-icon">ht<wbr>Placeline</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#htstop" class="tsd-kind-icon">ht<wbr>Stop</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#htuser" class="tsd-kind-icon">ht<wbr>User</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#iscurrentaccount" class="tsd-kind-icon">is<wbr>Current<wbr>Account</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#issamedaterange" class="tsd-kind-icon">is<wbr>Same<wbr>Date<wbr>Range</a>
		</li>
		<li class=" tsd-kind-function tsd-has-type-parameter">
			<a href="globals.html#itemaspage" class="tsd-kind-icon">item<wbr>AsPage</a>
		</li>
		<li class=" tsd-kind-function tsd-has-type-parameter">
			<a href="globals.html#itemaspage_" class="tsd-kind-icon">item<wbr>AsPage$</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#listwithitem_" class="tsd-kind-icon">list<wbr>With<wbr>Item$</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#listwithselectedid_" class="tsd-kind-icon">listwith<wbr>Selected<wbr>Id$</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#orcombine" class="tsd-kind-icon">or<wbr>Combine</a>
		</li>
		<li class=" tsd-kind-function">
			<a href="globals.html#tableformat" class="tsd-kind-icon">table<wbr>Format</a>
		</li>
		<li class=" tsd-kind-object-literal">
			<a href="globals.html#commonfunctions" class="tsd-kind-icon">Common<wbr>Functions</a>
		</li>
		<li class=" tsd-kind-object-literal">
			<a href="globals.html#daterangemap" class="tsd-kind-icon">Date<wbr>Range<wbr>Map</a>
		</li>
		<li class=" tsd-kind-object-literal">
			<a href="globals.html#actiontableformat" class="tsd-kind-icon">action<wbr>Table<wbr>Format</a>
		</li>
		<li class=" tsd-kind-object-literal">
			<a href="globals.html#usertableformat" class="tsd-kind-icon">user<wbr>Table<wbr>Format</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class"><a href="classes/htaction.html" class="tsd-kind-icon">Ht<wbr>Action</a></li>
							<li class="tsd-kind-class"><a href="classes/htevent.html" class="tsd-kind-icon">Ht<wbr>Event</a></li>
							<li class="tsd-kind-class"><a href="classes/htplaceline.html" class="tsd-kind-icon">Ht<wbr>Placeline</a></li>
							<li class="tsd-kind-class"><a href="classes/htstop.html" class="tsd-kind-icon">Ht<wbr>Stop</a></li>
							<li class="tsd-kind-class"><a href="classes/htuser.html" class="tsd-kind-icon">Ht<wbr>User</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface"><a href="interfaces/data.html" class="tsd-kind-icon">Data</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/htposition.html" class="tsd-kind-icon">Ht<wbr>Position</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/iactionmark.html" class="tsd-kind-icon">IAction<wbr>Mark</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/iactionpositions.html" class="tsd-kind-icon">IAction<wbr>Positions</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/iactivitysegment.html" class="tsd-kind-icon">IActivity<wbr>Segment</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/iallowedquerymap.html" class="tsd-kind-icon">IAllowed<wbr>Query<wbr>Map</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/ieventdisplay.html" class="tsd-kind-icon">IEvent<wbr>Display</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/ieventmark.html" class="tsd-kind-icon">IEvent<wbr>Mark</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/iplacelinesegment.html" class="tsd-kind-icon">IPlaceline<wbr>Segment</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/iprocsegment.html" class="tsd-kind-icon">IProc<wbr>Segment</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/ireplaysegment.html" class="tsd-kind-icon">IReplay<wbr>Segment</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/isegmentstyle.html" class="tsd-kind-icon">ISegment<wbr>Style</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/isegmenttype.html" class="tsd-kind-icon">ISegment<wbr>Type</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/itableformat.html" class="tsd-kind-icon">ITable<wbr>Format</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/itableformatconfig.html" class="tsd-kind-icon">ITable<wbr>Format<wbr>Config</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Variables</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable"><a href="globals.html#datemapservice" class="tsd-kind-icon">Date<wbr>Map<wbr>Service</a></li>
							<li class="tsd-kind-variable"><a href="globals.html#daterangelabelmap" class="tsd-kind-icon">Date<wbr>Range<wbr>Label<wbr>Map</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function"><a href="globals.html#allowedquerykeys_" class="tsd-kind-icon">Allowed<wbr>Query<wbr>Keys$</a></li>
							<li class="tsd-kind-function"><a href="globals.html#allowedquerymap" class="tsd-kind-icon">Allowed<wbr>Query<wbr>Map</a></li>
							<li class="tsd-kind-function"><a href="globals.html#combineloadings_" class="tsd-kind-icon">Combine<wbr>Loadings$</a></li>
							<li class="tsd-kind-function"><a href="globals.html#combinequeries" class="tsd-kind-icon">Combine<wbr>Queries</a></li>
							<li class="tsd-kind-function"><a href="globals.html#daterangetoquery_" class="tsd-kind-icon">Date<wbr>Range<wbr>ToQuery$</a></li>
							<li class="tsd-kind-function"><a href="globals.html#getsecrettoken" class="tsd-kind-icon">Get<wbr>Secret<wbr>Token</a></li>
							<li class="tsd-kind-function"><a href="globals.html#iscurrentmember" class="tsd-kind-icon">Is<wbr>Current<wbr>Member</a></li>
							<li class="tsd-kind-function"><a href="globals.html#mergequery" class="tsd-kind-icon">Merge<wbr>Query</a></li>
							<li class="tsd-kind-function"><a href="globals.html#pageresults_" class="tsd-kind-icon">Page<wbr>Results$</a></li>
							<li class="tsd-kind-function"><a href="globals.html#updatesubaccountofaccount" class="tsd-kind-icon">Update<wbr>Sub<wbr>Account<wbr>OfAccount</a></li>
							<li class="tsd-kind-function"><a href="globals.html#andcombine" class="tsd-kind-icon">and<wbr>Combine</a></li>
							<li class="tsd-kind-function"><a href="globals.html#datawithselectedid_" class="tsd-kind-icon">data<wbr>With<wbr>Selected<wbr>Id$</a></li>
							<li class="tsd-kind-function tsd-is-not-exported"><a href="globals.html#datetimestring" class="tsd-kind-icon">date<wbr>Time<wbr>String</a></li>
							<li class="tsd-kind-function"><a href="globals.html#entitydatafactory" class="tsd-kind-icon">entity<wbr>Data<wbr>Factory</a></li>
							<li class="tsd-kind-function"><a href="globals.html#getaccountfromaccountuserid" class="tsd-kind-icon">get<wbr>Account<wbr>From<wbr>Account<wbr>User<wbr>Id</a></li>
							<li class="tsd-kind-function"><a href="globals.html#getauthheaders" class="tsd-kind-icon">get<wbr>Auth<wbr>Headers</a></li>
							<li class="tsd-kind-function tsd-is-not-exported"><a href="globals.html#getsubaccounttoken" class="tsd-kind-icon">get<wbr>Sub<wbr>Account<wbr>Token</a></li>
							<li class="tsd-kind-function"><a href="globals.html#gettoken" class="tsd-kind-icon">get<wbr>Token</a></li>
							<li class="tsd-kind-function"><a href="globals.html#htaction" class="tsd-kind-icon">ht<wbr>Action</a></li>
							<li class="tsd-kind-function"><a href="globals.html#htevent" class="tsd-kind-icon">ht<wbr>Event</a></li>
							<li class="tsd-kind-function"><a href="globals.html#htplaceline" class="tsd-kind-icon">ht<wbr>Placeline</a></li>
							<li class="tsd-kind-function"><a href="globals.html#htstop" class="tsd-kind-icon">ht<wbr>Stop</a></li>
							<li class="tsd-kind-function"><a href="globals.html#htuser" class="tsd-kind-icon">ht<wbr>User</a></li>
							<li class="tsd-kind-function"><a href="globals.html#iscurrentaccount" class="tsd-kind-icon">is<wbr>Current<wbr>Account</a></li>
							<li class="tsd-kind-function"><a href="globals.html#issamedaterange" class="tsd-kind-icon">is<wbr>Same<wbr>Date<wbr>Range</a></li>
							<li class="tsd-kind-function tsd-has-type-parameter"><a href="globals.html#itemaspage" class="tsd-kind-icon">item<wbr>AsPage</a></li>
							<li class="tsd-kind-function tsd-has-type-parameter"><a href="globals.html#itemaspage_" class="tsd-kind-icon">item<wbr>AsPage$</a></li>
							<li class="tsd-kind-function"><a href="globals.html#listwithitem_" class="tsd-kind-icon">list<wbr>With<wbr>Item$</a></li>
							<li class="tsd-kind-function"><a href="globals.html#listwithselectedid_" class="tsd-kind-icon">listwith<wbr>Selected<wbr>Id$</a></li>
							<li class="tsd-kind-function"><a href="globals.html#orcombine" class="tsd-kind-icon">or<wbr>Combine</a></li>
							<li class="tsd-kind-function"><a href="globals.html#tableformat" class="tsd-kind-icon">table<wbr>Format</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Object literals</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-object-literal"><a href="globals.html#commonfunctions" class="tsd-kind-icon">Common<wbr>Functions</a></li>
							<li class="tsd-kind-object-literal"><a href="globals.html#daterangemap" class="tsd-kind-icon">Date<wbr>Range<wbr>Map</a></li>
							<li class="tsd-kind-object-literal"><a href="globals.html#actiontableformat" class="tsd-kind-icon">action<wbr>Table<wbr>Format</a></li>
							<li class="tsd-kind-object-literal"><a href="globals.html#usertableformat" class="tsd-kind-icon">user<wbr>Table<wbr>Format</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable">
				<a name="datemapservice" class="tsd-anchor"></a>
				<h3>Date<wbr>Map<wbr>Service</h3>
				<div class="tsd-signature tsd-kind-icon">Date<wbr>Map<wbr>Service<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span><span class="tsd-signature-symbol"> =&nbsp;(() &#x3D;&gt; {let instance;return {getInstance() {if(!instance) {instance &#x3D; {today_end:   moment().endOf(&#x27;day&#x27;).toISOString(),today_start: moment().startOf(&#x27;day&#x27;).toISOString(),yesterday_start: moment().subtract(1, &#x27;days&#x27;).toISOString(),yesterday_end: moment().subtract(1, &#x27;days&#x27;).endOf(&#x27;day&#x27;).toISOString(),day_7_start: moment().subtract(6, &#x27;days&#x27;).toISOString(),month_start: moment().startOf(&#x27;month&#x27;).toISOString(),day_30_start: moment().subtract(29, &#x27;days&#x27;).toISOString(),};}return instance;}}})()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L3">utils/date-range.ts:3</a></li>
					</ul>
				</aside>
				<div class="tsd-type-declaration">
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter">
							<h5>get<wbr>Instance<span class="tsd-signature-symbol">: </span>function</h5>
							<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-type-literal tsd-is-not-exported">
								<li class="tsd-signature tsd-kind-icon">get<wbr>Instance<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
							</ul>
							<ul class="tsd-descriptions">
								<li class="tsd-description">
									<aside class="tsd-sources">
										<ul>
											<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L6">utils/date-range.ts:6</a></li>
										</ul>
									</aside>
			...
			<section class="tsd-panel tsd-member tsd-kind-variable">
				<a name="daterangelabelmap" class="tsd-anchor"></a>
				<h3>Date<wbr>Range<wbr>Label<wbr>Map</h3>
				<div class="tsd-signature tsd-kind-icon">Date<wbr>Range<wbr>Label<wbr>Map<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> =&nbsp;[{label: &quot;Today&quot;,range: DateRangeMap.today,isSingleDay: true,hasToday: true},{label: &quot;Yesterday&quot;,range: DateRangeMap.yesterday,isSingleDay: true,hasToday: false},{label: &quot;Last 7 days&quot;,range: DateRangeMap.last_7_days,isSingleDay: false,hasToday: true},{label: &quot;This month&quot;,range: DateRangeMap.this_month,isSingleDay: false,hasToday: true},{label: &quot;Last 30 days&quot;,range: DateRangeMap.last_30_days,isSingleDay: false,hasToday: true}]</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L46">utils/date-range.ts:46</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="allowedquerykeys_" class="tsd-anchor"></a>
				<h3>Allowed<wbr>Query<wbr>Keys$</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Allowed<wbr>Query<wbr>Keys$<span class="tsd-signature-symbol">(</span>allowedQueryKeys<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">(Anonymous function)</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/allowed-query.ts#L5">rx-helpers/allowed-query.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> allowedQueryKeys: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span></h5>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="allowedquerymap" class="tsd-anchor"></a>
				<h3>Allowed<wbr>Query<wbr>Map</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Allowed<wbr>Query<wbr>Map<span class="tsd-signature-symbol">(</span>allowedQueryMaps<span class="tsd-signature-symbol">?: </span><a href="interfaces/iallowedquerymap.html" class="tsd-signature-type">IAllowedQueryMap</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">(Anonymous function)</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/allowed-query.ts#L33">rx-helpers/allowed-query.ts:33</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> allowedQueryMaps: <a href="interfaces/iallowedquerymap.html" class="tsd-signature-type">IAllowedQueryMap</a><span class="tsd-signature-symbol">[]</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">(Anonymous function)</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="combineloadings_" class="tsd-anchor"></a>
				<h3>Combine<wbr>Loadings$</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Combine<wbr>Loadings$<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">...</span>args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/combine-loadings.ts#L5">rx-helpers/combine-loadings.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagRest">Rest</span> <span class="tsd-signature-symbol">...</span>args: <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span></h5>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="combinequeries" class="tsd-anchor"></a>
				<h3>Combine<wbr>Queries</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Combine<wbr>Queries<span class="tsd-signature-symbol">(</span>addQueries$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">(Anonymous function)</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/combine-queries.ts#L4">rx-helpers/combine-queries.ts:4</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>addQueries$: <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">(Anonymous function)</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="daterangetoquery_" class="tsd-anchor"></a>
				<h3>Date<wbr>Range<wbr>ToQuery$</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Date<wbr>Range<wbr>ToQuery$<span class="tsd-signature-symbol">(</span>dateRangeParam<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/daterange-query.ts#L5">rx-helpers/daterange-query.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>dateRangeParam: <span class="tsd-signature-type">string</span></h5>
							</li>
						</ul>
						...
						<ul class="tsd-parameters">
							<li class="tsd-parameter-siganture">
								<ul class="tsd-signatures tsd-kind-type-literal tsd-is-not-exported">
									<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>param<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">IDateRange</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></li>
								</ul>
								<ul class="tsd-descriptions">
									<li class="tsd-description">
										<h4 class="tsd-parameters-title">Parameters</h4>
										<ul class="tsd-parameters">
											<li>
												<h5>param: <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">IDateRange</span><span class="tsd-signature-symbol">&gt;</span></h5>
											</li>
										</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="getsecrettoken" class="tsd-anchor"></a>
				<h3>Get<wbr>Secret<wbr>Token</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Get<wbr>Secret<wbr>Token<span class="tsd-signature-symbol">(</span>account<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAccount</span>, tokenType<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">"test"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"production"</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L61">entities/account-user.ts:61</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>account: <span class="tsd-signature-type">IAccount</span></h5>
							</li>
							<li>
								<h5>tokenType: <span class="tsd-signature-type">"test"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"production"</span></h5>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="iscurrentmember" class="tsd-anchor"></a>
				<h3>Is<wbr>Current<wbr>Member</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Is<wbr>Current<wbr>Member<span class="tsd-signature-symbol">(</span>member<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IMembership</span>, token<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, tokenType<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">"test"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"production"</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L53">entities/account-user.ts:53</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>member: <span class="tsd-signature-type">IMembership</span></h5>
							</li>
							<li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="mergequery" class="tsd-anchor"></a>
				<h3>Merge<wbr>Query</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Merge<wbr>Query<span class="tsd-signature-symbol">(</span>defaultQuery<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">(Anonymous function)</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/merge-query.ts#L3">rx-helpers/merge-query.ts:3</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>defaultQuery: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">(Anonymous function)</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="pageresults_" class="tsd-anchor"></a>
				<h3>Page<wbr>Results$</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Page<wbr>Results$<span class="tsd-signature-symbol">(</span>pageData$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Page</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">AllData</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/page-results.ts#L5">rx-helpers/page-results.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>pageData$: <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Page</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">AllData</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span><span class="tsd-signature-symbol">&gt;</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="updatesubaccountofaccount" class="tsd-anchor"></a>
				<h3>Update<wbr>Sub<wbr>Account<wbr>OfAccount</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">Update<wbr>Sub<wbr>Account<wbr>OfAccount<span class="tsd-signature-symbol">(</span>account<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAccount</span>, updatedSubAccount<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ISubAccount</span>, tokenType<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAccount</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L10">entities/account-user.ts:10</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							...
							<li>
								<h5>updatedSubAccount: <span class="tsd-signature-type">ISubAccount</span></h5>
							</li>
							<li>
								<h5>tokenType: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">IAccount</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="andcombine" class="tsd-anchor"></a>
				<h3>and<wbr>Combine</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">and<wbr>Combine<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">...</span>source$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/and-combine.ts#L5">rx-helpers/and-combine.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagRest">Rest</span> <span class="tsd-signature-symbol">...</span>source$: <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="datawithselectedid_" class="tsd-anchor"></a>
				<h3>data<wbr>With<wbr>Selected<wbr>Id$</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">data<wbr>With<wbr>Selected<wbr>Id$<span class="tsd-signature-symbol">(</span>data$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, id$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, keys<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/data-intercepter.ts#L8">rx-helpers/data-intercepter.ts:8</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-not-exported">
				<a name="datetimestring" class="tsd-anchor"></a>
				<h3>date<wbr>Time<wbr>String</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">date<wbr>Time<wbr>String<span class="tsd-signature-symbol">(</span>time<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L151">utils/table-format.ts:151</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="entitydatafactory" class="tsd-anchor"></a>
				<h3>entity<wbr>Data<wbr>Factory</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">entity<wbr>Data<wbr>Factory<span class="tsd-signature-symbol">(</span>data<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/entity-data-factory.ts#L1">entities/entity-data-factory.ts:1</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="getaccountfromaccountuserid" class="tsd-anchor"></a>
				<h3>get<wbr>Account<wbr>From<wbr>Account<wbr>User<wbr>Id</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Account<wbr>From<wbr>Account<wbr>User<wbr>Id<span class="tsd-signature-symbol">(</span>accountUser<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, accountId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L75">entities/account-user.ts:75</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>accountUser: <span class="tsd-signature-type">any</span></h5>
							</li>
							<li>
								<h5>accountId: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">any</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="getauthheaders" class="tsd-anchor"></a>
				<h3>get<wbr>Auth<wbr>Headers</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Auth<wbr>Headers<span class="tsd-signature-symbol">(</span>token<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L93">entities/account-user.ts:93</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
						...
						<ul class="tsd-parameters">
							<li class="tsd-parameter">
								<h5>Authorization<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5>
							</li>
						</ul>
					</li>
				</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-not-exported">
				<a name="getsubaccounttoken" class="tsd-anchor"></a>
				<h3>get<wbr>Sub<wbr>Account<wbr>Token</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Sub<wbr>Account<wbr>Token<span class="tsd-signature-symbol">(</span>account<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAccount</span>, type<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IToken</span><span class="tsd-signature-symbol">[]</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L87">entities/account-user.ts:87</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">IToken</span><span class="tsd-signature-symbol">[]</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<h3>get<wbr>Token</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Token<span class="tsd-signature-symbol">(</span>subAccounts<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IToken</span><span class="tsd-signature-symbol">[]</span>, type<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L68">entities/account-user.ts:68</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>subAccounts: <span class="tsd-signature-type">IToken</span><span class="tsd-signature-symbol">[]</span></h5>
							</li>
							<li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="htaction" class="tsd-anchor"></a>
				<h3>ht<wbr>Action</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">ht<wbr>Action<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="classes/htaction.html" class="tsd-signature-type">HtAction</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/action.ts#L179">entities/action.ts:179</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> action: <span class="tsd-signature-type">IAction</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="classes/htaction.html" class="tsd-signature-type">HtAction</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="htevent" class="tsd-anchor"></a>
				<h3>ht<wbr>Event</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">ht<wbr>Event<span class="tsd-signature-symbol">(</span>event<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">IEvent</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="classes/htevent.html" class="tsd-signature-type">HtEvent</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/event.ts#L49">entities/event.ts:49</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> event: <span class="tsd-signature-type">IEvent</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="classes/htevent.html" class="tsd-signature-type">HtEvent</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="htplaceline" class="tsd-anchor"></a>
				<h3>ht<wbr>Placeline</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">ht<wbr>Placeline<span class="tsd-signature-symbol">(</span>userData<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserData</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="classes/htplaceline.html" class="tsd-signature-type">HtPlaceline</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/placeline.ts#L280">entities/placeline.ts:280</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>userData: <span class="tsd-signature-type">IUserData</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="classes/htplaceline.html" class="tsd-signature-type">HtPlaceline</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="htstop" class="tsd-anchor"></a>
				<h3>ht<wbr>Stop</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">ht<wbr>Stop<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">ISegment</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="classes/htstop.html" class="tsd-signature-type">HtStop</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/stop.ts#L17">entities/stop.ts:17</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> action: <span class="tsd-signature-type">ISegment</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="classes/htstop.html" class="tsd-signature-type">HtStop</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="htuser" class="tsd-anchor"></a>
				<h3>ht<wbr>User</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">ht<wbr>User<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">IUser</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">IUserData</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/user.ts#L125">entities/user.ts:125</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> user: <span class="tsd-signature-type">IUser</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">IUserData</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">IUserAnalytics</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">object</span></h4>
						<ul class="tsd-parameters">
							<li class="tsd-parameter">
								<h5>data<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUser</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">IUserData</span></h5>
							</li>
							<li class="tsd-parameter">
								<h5>get<wbr>Info<wbr>Content<span class="tsd-signature-symbol">: </span>function</h5>
								<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-type-literal tsd-is-not-exported">
									<li class="tsd-signature tsd-kind-icon">get<wbr>Info<wbr>Content<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
								</ul>
								<ul class="tsd-descriptions">
									<li class="tsd-description">
										<aside class="tsd-sources">
											<ul>
												<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/user.ts#L217">entities/user.ts:217</a></li>
											</ul>
										</aside>
										<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">any</span></h4>
									</li>
							...
							<li class="tsd-parameter">
								<h5>get<wbr>Position<span class="tsd-signature-symbol">: </span>function</h5>
								<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-type-literal tsd-is-not-exported">
									<li class="tsd-signature tsd-kind-icon">get<wbr>Position<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="interfaces/htposition.html" class="tsd-signature-type">HtPosition</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span></li>
								</ul>
								<ul class="tsd-descriptions">
									<li class="tsd-description">
										<aside class="tsd-sources">
											<ul>
												<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/user.ts#L201">entities/user.ts:201</a></li>
											</ul>
										</aside>
										<h4 class="tsd-returns-title">Returns <a href="interfaces/htposition.html" class="tsd-signature-type">HtPosition</a>
							...
							<li class="tsd-parameter">
								<h5>get<wbr>Valid<wbr>Position<span class="tsd-signature-symbol">: </span>function</h5>
								<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-type-literal tsd-is-not-exported">
									<li class="tsd-signature tsd-kind-icon">get<wbr>Valid<wbr>Position<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="interfaces/htposition.html" class="tsd-signature-type">HtPosition</a></li>
								</ul>
								<ul class="tsd-descriptions">
									<li class="tsd-description">
										<aside class="tsd-sources">
											<ul>
												<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/user.ts#L208">entities/user.ts:208</a></li>
											</ul>
										</aside>
										<h4 class="tsd-returns-title">Returns <a href="interfaces/htposition.html" class="tsd-signature-type">HtPosition</a></h4>
									</li>
							</ul>        </li>
							<li class="tsd-parameter">
								<h5>is<wbr>Valid<wbr>Marker<span class="tsd-signature-symbol">: </span>function</h5>
								<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-type-literal tsd-is-not-exported">
									<li class="tsd-signature tsd-kind-icon">is<wbr>Valid<wbr>Marker<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
								</ul>
								<ul class="tsd-descriptions">
									<li class="tsd-description">
										<aside class="tsd-sources">
											<ul>
												<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/user.ts#L197">entities/user.ts:197</a></li>
											</ul>
										</aside>
										<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
									</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="iscurrentaccount" class="tsd-anchor"></a>
				<h3>is<wbr>Current<wbr>Account</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">is<wbr>Current<wbr>Account<span class="tsd-signature-symbol">(</span>account<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAccount</span>, token<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, tokenType<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">"test"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"production"</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/account-user.ts#L45">entities/account-user.ts:45</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="issamedaterange" class="tsd-anchor"></a>
				<h3>is<wbr>Same<wbr>Date<wbr>Range</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">is<wbr>Same<wbr>Date<wbr>Range<span class="tsd-signature-symbol">(</span>range1<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, range2<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L79">utils/date-range.ts:79</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>range1: <span class="tsd-signature-type">any</span></h5>
							</li>
							<li>
								<h5>range2: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-has-type-parameter">
				<a name="itemaspage" class="tsd-anchor"></a>
				<h3>item<wbr>AsPage</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-has-type-parameter">
					<li class="tsd-signature tsd-kind-icon">item<wbr>AsPage&lt;T&gt;<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">(Anonymous function)</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/operators/item-as-page.ts#L5">operators/item-as-page.ts:5</a></li>
							</ul>
						</aside>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-has-type-parameter">
				<a name="itemaspage_" class="tsd-anchor"></a>
				<h3>item<wbr>AsPage$</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-has-type-parameter">
					<li class="tsd-signature tsd-kind-icon">item<wbr>AsPage$&lt;T&gt;<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">(Anonymous function)</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/item-as-page.ts#L5">rx-helpers/item-as-page.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-type-parameters-title">Type parameters</h4>
						<ul class="tsd-type-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="listwithitem_" class="tsd-anchor"></a>
				<h3>list<wbr>With<wbr>Item$</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">list<wbr>With<wbr>Item$<span class="tsd-signature-symbol">(</span>list$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, item$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Object</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/data-intercepter.ts#L54">rx-helpers/data-intercepter.ts:54</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>list$: <span class="tsd-signature-type">any</span></h5>
							</li>
							<li>
								<h5>item$: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Object</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="listwithselectedid_" class="tsd-anchor"></a>
				<h3>listwith<wbr>Selected<wbr>Id$</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">listwith<wbr>Selected<wbr>Id$<span class="tsd-signature-symbol">(</span>list$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, id$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/data-intercepter.ts#L34">rx-helpers/data-intercepter.ts:34</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="orcombine" class="tsd-anchor"></a>
				<h3>or<wbr>Combine</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">or<wbr>Combine<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">...</span>source$<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Observable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/rx-helpers/or-combine.ts#L5">rx-helpers/or-combine.ts:5</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				<a name="tableformat" class="tsd-anchor"></a>
				<h3>table<wbr>Format</h3>
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">table<wbr>Format<span class="tsd-signature-symbol">(</span>data<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span>, config<span class="tsd-signature-symbol">: </span><a href="interfaces/itableformatconfig.html" class="tsd-signature-type">ITableFormatConfig</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L4">utils/table-format.ts:4</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							...
							<li>
								<h5>config: <a href="interfaces/itableformatconfig.html" class="tsd-signature-type">ITableFormatConfig</a></h5>
							</li>
						</ul>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-object-literal">
				<a name="commonfunctions" class="tsd-anchor"></a>
				<h3>Common<wbr>Functions</h3>
				<div class="tsd-signature tsd-kind-icon">Common<wbr>Functions<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/common.ts#L1">common.ts:1</a></li>
					</ul>
				</aside>
				<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
					<a name="commonfunctions.setentitycountmap" class="tsd-anchor"></a>
					<h3>set<wbr>Entity<wbr>Count<wbr>Map</h3>
					<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
						<li class="tsd-signature tsd-kind-icon">set<wbr>Entity<wbr>Count<wbr>Map<span class="tsd-signature-symbol">(</span>entity<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">object</span>, entityCountMap<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">object</span>, uniqueProp<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/common.ts#L2">common.ts:2</a></li>
								</ul>
							</aside>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								<li>
									<h5><span class="tsd-flag ts-flagDefault value">Default value</span> entity: <span class="tsd-signature-type">object</span><span class="tsd-signature-symbol"> =&nbsp;{}</span></h5>
									<ul class="tsd-parameters">
									</ul>
								</li>
								<li>
									<h5><span class="tsd-flag ts-flagDefault value">Default value</span> entityCountMap: <span class="tsd-signature-type">object</span><span class="tsd-signature-symbol"> =&nbsp;{}</span></h5>
									<ul class="tsd-parameters">
									</ul>
								</li>
								<li>
									<h5><span class="tsd-flag ts-flagDefault value">Default value</span> uniqueProp: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;id&quot;</span></h5>
								</li>
							</ul>
							<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">object</span></h4>
							<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-object-literal">
				<a name="daterangemap" class="tsd-anchor"></a>
				<h3>Date<wbr>Range<wbr>Map</h3>
				<div class="tsd-signature tsd-kind-icon">Date<wbr>Range<wbr>Map<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L23">utils/date-range.ts:23</a></li>
					</ul>
				</aside>
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="daterangemap.last_30_days" class="tsd-anchor"></a>
					<h3>last_<wbr>30_<wbr>days</h3>
					<div class="tsd-signature tsd-kind-icon">last_<wbr>30_<wbr>days<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L40">utils/date-range.ts:40</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.last_30_days.end" class="tsd-anchor"></a>
						<h3>end</h3>
						<div class="tsd-signature tsd-kind-icon">end<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().today_end</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L42">utils/date-range.ts:42</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.last_30_days.start" class="tsd-anchor"></a>
						<h3>start</h3>
						<div class="tsd-signature tsd-kind-icon">start<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().day_30_start</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L41">utils/date-range.ts:41</a></li>
							</ul>
						</aside>
					</section>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="daterangemap.last_7_days" class="tsd-anchor"></a>
					<h3>last_<wbr>7_days</h3>
					<div class="tsd-signature tsd-kind-icon">last_<wbr>7_days<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L32">utils/date-range.ts:32</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.last_7_days.end-1" class="tsd-anchor"></a>
						<h3>end</h3>
						<div class="tsd-signature tsd-kind-icon">end<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().today_end</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L34">utils/date-range.ts:34</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.last_7_days.start-1" class="tsd-anchor"></a>
						<h3>start</h3>
						<div class="tsd-signature tsd-kind-icon">start<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().day_7_start</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L33">utils/date-range.ts:33</a></li>
							</ul>
						</aside>
					</section>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="daterangemap.this_month" class="tsd-anchor"></a>
					<h3>this_<wbr>month</h3>
					<div class="tsd-signature tsd-kind-icon">this_<wbr>month<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L36">utils/date-range.ts:36</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.this_month.end-2" class="tsd-anchor"></a>
						<h3>end</h3>
						<div class="tsd-signature tsd-kind-icon">end<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().today_end</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L38">utils/date-range.ts:38</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.this_month.start-2" class="tsd-anchor"></a>
						<h3>start</h3>
						<div class="tsd-signature tsd-kind-icon">start<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().month_start</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L37">utils/date-range.ts:37</a></li>
							</ul>
						</aside>
					</section>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="daterangemap.today" class="tsd-anchor"></a>
					<h3>today</h3>
					<div class="tsd-signature tsd-kind-icon">today<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L24">utils/date-range.ts:24</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.today.end-3" class="tsd-anchor"></a>
						<h3>end</h3>
						<div class="tsd-signature tsd-kind-icon">end<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().today_end</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L26">utils/date-range.ts:26</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.today.start-3" class="tsd-anchor"></a>
						<h3>start</h3>
						<div class="tsd-signature tsd-kind-icon">start<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().today_start</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L25">utils/date-range.ts:25</a></li>
							</ul>
						</aside>
					</section>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="daterangemap.yesterday" class="tsd-anchor"></a>
					<h3>yesterday</h3>
					<div class="tsd-signature tsd-kind-icon">yesterday<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L28">utils/date-range.ts:28</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.yesterday.end-4" class="tsd-anchor"></a>
						<h3>end</h3>
						<div class="tsd-signature tsd-kind-icon">end<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().yesterday_end</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L30">utils/date-range.ts:30</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="daterangemap.yesterday.start-4" class="tsd-anchor"></a>
						<h3>start</h3>
						<div class="tsd-signature tsd-kind-icon">start<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol"> =&nbsp;DateMapService.getInstance().yesterday_start</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/date-range.ts#L29">utils/date-range.ts:29</a></li>
							</ul>
						</aside>
					</section>
				</section>
			...
			<section class="tsd-panel tsd-member tsd-kind-object-literal">
				<a name="actiontableformat" class="tsd-anchor"></a>
				<h3>action<wbr>Table<wbr>Format</h3>
				<div class="tsd-signature tsd-kind-icon">action<wbr>Table<wbr>Format<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L27">utils/table-format.ts:27</a></li>
					</ul>
				</aside>
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.assigned_at" class="tsd-anchor"></a>
					<h3>assigned_<wbr>at</h3>
					<div class="tsd-signature tsd-kind-icon">assigned_<wbr>at<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L28">utils/table-format.ts:28</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.assigned_at.label" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Assigned at&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L29">utils/table-format.ts:29</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.assigned_at.selector" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L30">utils/table-format.ts:30</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
									<li>
										<h5>action: <span class="tsd-signature-type">IAction</span></h5>
									</li>
								</ul>
								<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4>
							</li>
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.completed_at" class="tsd-anchor"></a>
					<h3>completed_<wbr>at</h3>
					<div class="tsd-signature tsd-kind-icon">completed_<wbr>at<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L40">utils/table-format.ts:40</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.completed_at.label-1" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Completed at&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L41">utils/table-format.ts:41</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.completed_at.selector-1" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L42">utils/table-format.ts:42</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.distance" class="tsd-anchor"></a>
					<h3>distance</h3>
					<div class="tsd-signature tsd-kind-icon">distance<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L46">utils/table-format.ts:46</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.distance.label-2" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Distance&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L47">utils/table-format.ts:47</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.distance.selector-2" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L48">utils/table-format.ts:48</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.distance_duration" class="tsd-anchor"></a>
					<h3>distance&duration</h3>
					<div class="tsd-signature tsd-kind-icon">distance&duration<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L64">utils/table-format.ts:64</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.distance_duration.label-3" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Distance/Duration&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L65">utils/table-format.ts:65</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.distance_duration.selector-3" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L66">utils/table-format.ts:66</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.duration" class="tsd-anchor"></a>
					<h3>duration</h3>
					<div class="tsd-signature tsd-kind-icon">duration<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L52">utils/table-format.ts:52</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.duration.label-4" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Duration&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L53">utils/table-format.ts:53</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.duration.selector-4" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L54">utils/table-format.ts:54</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.expected_at" class="tsd-anchor"></a>
					<h3>expected_<wbr>at</h3>
					<div class="tsd-signature tsd-kind-icon">expected_<wbr>at<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L34">utils/table-format.ts:34</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.expected_at.label-5" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Expected at&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L35">utils/table-format.ts:35</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.expected_at.selector-5" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L36">utils/table-format.ts:36</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.scheduled_at" class="tsd-anchor"></a>
					<h3>scheduled_<wbr>at</h3>
					<div class="tsd-signature tsd-kind-icon">scheduled_<wbr>at<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L58">utils/table-format.ts:58</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.scheduled_at.label-6" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Scheduled at&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L59">utils/table-format.ts:59</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.scheduled_at.selector-6" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L60">utils/table-format.ts:60</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="actiontableformat.type" class="tsd-anchor"></a>
					<h3>type</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L70">utils/table-format.ts:70</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="actiontableformat.type.label-7" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Type&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L71">utils/table-format.ts:71</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="actiontableformat.type.selector-7" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>action<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IAction</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L72">utils/table-format.ts:72</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-object-literal">
				<a name="usertableformat" class="tsd-anchor"></a>
				<h3>user<wbr>Table<wbr>Format</h3>
				<div class="tsd-signature tsd-kind-icon">user<wbr>Table<wbr>Format<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L78">utils/table-format.ts:78</a></li>
					</ul>
				</aside>
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.last_battery" class="tsd-anchor"></a>
					<h3>last_<wbr>battery</h3>
					<div class="tsd-signature tsd-kind-icon">last_<wbr>battery<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L91">utils/table-format.ts:91</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.last_battery.label" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Last battery&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L92">utils/table-format.ts:92</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.last_battery.selector" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUser</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L93">utils/table-format.ts:93</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
									<li>
										<h5>user: <span class="tsd-signature-type">IUser</span></h5>
									</li>
								</ul>
								<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4>
							</li>
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.last_heartbeat_at" class="tsd-anchor"></a>
					<h3>last_<wbr>heartbeat_<wbr>at</h3>
					<div class="tsd-signature tsd-kind-icon">last_<wbr>heartbeat_<wbr>at<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L85">utils/table-format.ts:85</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.last_heartbeat_at.label-1" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Last updated at&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L86">utils/table-format.ts:86</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.last_heartbeat_at.selector-1" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L87">utils/table-format.ts:87</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
									<li>
										<h5>user: <span class="tsd-signature-type">IUserAnalytics</span></h5>
									</li>
								</ul>
								<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4>
							</li>
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.location_disabled_duration" class="tsd-anchor"></a>
					<h3>location_<wbr>disabled_<wbr>duration</h3>
					<div class="tsd-signature tsd-kind-icon">location_<wbr>disabled_<wbr>duration<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L109">utils/table-format.ts:109</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.location_disabled_duration.label-2" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Location disabled duration&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L110">utils/table-format.ts:110</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.location_disabled_duration.selector-2" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L111">utils/table-format.ts:111</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.network_offline_duration" class="tsd-anchor"></a>
					<h3>network_<wbr>offline_<wbr>duration</h3>
					<div class="tsd-signature tsd-kind-icon">network_<wbr>offline_<wbr>duration<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L127">utils/table-format.ts:127</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.network_offline_duration.label-3" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Network offline duration&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L128">utils/table-format.ts:128</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.network_offline_duration.selector-3" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L129">utils/table-format.ts:129</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.num_actions" class="tsd-anchor"></a>
					<h3>num_<wbr>actions</h3>
					<div class="tsd-signature tsd-kind-icon">num_<wbr>actions<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L133">utils/table-format.ts:133</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.num_actions.label-4" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Number of actions&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L134">utils/table-format.ts:134</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.num_actions.selector-4" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L135">utils/table-format.ts:135</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.num_places" class="tsd-anchor"></a>
					<h3>num_<wbr>places</h3>
					<div class="tsd-signature tsd-kind-icon">num_<wbr>places<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L103">utils/table-format.ts:103</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.num_places.label-5" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Number of stops&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L104">utils/table-format.ts:104</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.num_places.selector-5" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L105">utils/table-format.ts:105</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.num_trips" class="tsd-anchor"></a>
					<h3>num_<wbr>trips</h3>
					<div class="tsd-signature tsd-kind-icon">num_<wbr>trips<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L121">utils/table-format.ts:121</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.num_trips.label-6" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Number of trips&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L122">utils/table-format.ts:122</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.num_trips.selector-6" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L123">utils/table-format.ts:123</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.stop_duration" class="tsd-anchor"></a>
					<h3>stop_<wbr>duration</h3>
					<div class="tsd-signature tsd-kind-icon">stop_<wbr>duration<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L79">utils/table-format.ts:79</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.stop_duration.label-7" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Stop Duration&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L80">utils/table-format.ts:80</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.stop_duration.selector-7" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L81">utils/table-format.ts:81</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.total_distance" class="tsd-anchor"></a>
					<h3>total_<wbr>distance</h3>
					<div class="tsd-signature tsd-kind-icon">total_<wbr>distance<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L115">utils/table-format.ts:115</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.total_distance.label-8" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Total distance&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L116">utils/table-format.ts:116</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.total_distance.selector-8" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L117">utils/table-format.ts:117</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-object-literal tsd-parent-kind-object-literal">
					<a name="usertableformat.total_duration" class="tsd-anchor"></a>
					<h3>total_<wbr>duration</h3>
					<div class="tsd-signature tsd-kind-icon">total_<wbr>duration<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L97">utils/table-format.ts:97</a></li>
						</ul>
					</aside>
					<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-object-literal">
						<a name="usertableformat.total_duration.label-9" class="tsd-anchor"></a>
						<h3>label</h3>
						<div class="tsd-signature tsd-kind-icon">label<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;&quot;Duration tracked&quot;</span></div>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L98">utils/table-format.ts:98</a></li>
							</ul>
						</aside>
					</section>
					<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-object-literal">
						<a name="usertableformat.total_duration.selector-9" class="tsd-anchor"></a>
						<h3>selector</h3>
						<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-object-literal">
							<li class="tsd-signature tsd-kind-icon">selector<span class="tsd-signature-symbol">(</span>user<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">IUserAnalytics</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						</ul>
						<ul class="tsd-descriptions">
							<li class="tsd-description">
								<aside class="tsd-sources">
									<ul>
										<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/utils/table-format.ts#L99">utils/table-format.ts:99</a></li>
									</ul>
								</aside>
								<h4 class="tsd-parameters-title">Parameters</h4>
								<ul class="tsd-parameters">
