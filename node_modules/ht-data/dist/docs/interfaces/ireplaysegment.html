...
<head>
	...
	<title>IReplaySegment | ht-data</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface">
			<a href="ireplaysegment.html" class="tsd-kind-icon">IReplay<wbr>Segment</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ireplaysegment.html#bearing" class="tsd-kind-icon">bearing</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ireplaysegment.html#endpercent" class="tsd-kind-icon">end<wbr>Percent</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="ireplaysegment.html#startpercent" class="tsd-kind-icon">start<wbr>Percent</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">IReplaySegment</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ireplaysegment.html#bearing" class="tsd-kind-icon">bearing</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ireplaysegment.html#endpercent" class="tsd-kind-icon">end<wbr>Percent</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="ireplaysegment.html#startpercent" class="tsd-kind-icon">start<wbr>Percent</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="bearing" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> bearing</h3>
				<div class="tsd-signature tsd-kind-icon">bearing<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/interfaces.ts#L56">interfaces.ts:56</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="endpercent" class="tsd-anchor"></a>
				<h3>end<wbr>Percent</h3>
				<div class="tsd-signature tsd-kind-icon">end<wbr>Percent<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/interfaces.ts#L55">interfaces.ts:55</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="startpercent" class="tsd-anchor"></a>
				<h3>start<wbr>Percent</h3>
				<div class="tsd-signature tsd-kind-icon">start<wbr>Percent<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/interfaces.ts#L54">interfaces.ts:54</a></li>
					</ul>
				</aside>
			</section>
		</section>
