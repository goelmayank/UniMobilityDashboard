...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class">
			<a href="htevent.html" class="tsd-kind-icon">Ht<wbr>Event</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class">
					<a href="htevent.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class">
					<a href="htevent.html#data" class="tsd-kind-icon">data</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="htevent.html#geteventdisplay" class="tsd-kind-icon">get<wbr>Event<wbr>Display</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">HtEvent</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class"><a href="htevent.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class"><a href="htevent.html#data" class="tsd-kind-icon">data</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="htevent.html#geteventdisplay" class="tsd-kind-icon">get<wbr>Event<wbr>Display</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">new <wbr>HtEvent<span class="tsd-signature-symbol">(</span>data<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">IEvent</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="htevent.html" class="tsd-signature-type">HtEvent</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/event.ts#L4">entities/event.ts:4</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> data: <span class="tsd-signature-type">IEvent</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="htevent.html" class="tsd-signature-type">HtEvent</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class">
				...
				<div class="tsd-signature tsd-kind-icon">data<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">IEvent</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/event.ts#L5">entities/event.ts:5</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3>get<wbr>Event<wbr>Display</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Event<wbr>Display<span class="tsd-signature-symbol">(</span>event<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">IEvent</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">ITimelineEvent</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/ieventdisplay.html" class="tsd-signature-type">IEventDisplay</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/hypertrack/js-sdk/blob/bdc0ec6/packages/data/src/entities/event.ts#L7">entities/event.ts:7</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> event: <span class="tsd-signature-type">IEvent</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">ITimelineEvent</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="../interfaces/ieventdisplay.html" class="tsd-signature-type">IEventDisplay</a></h4>
					</li>
				</ul>
			</section>
		</section>
