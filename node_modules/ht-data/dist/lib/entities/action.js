...
var HtAction = (function () {
    ...
    HtAction.prototype.isAwayFromExpected = function () {
        ...
        if (action.expected_place && action.event_flags) {
            var flag = underscore_1.default.find(action.event_flags, function (flag) {
    ...
    HtAction.prototype.getDateRangeQuery = function (query) {
        return ht_utility_1.GetDateRangeQuery(query, "created_at");
    };
    ...
    HtAction.prototype.getETATimestamp = function () {
        ...
        if (action.display.duration_remaining) {
            return date_fns_1.addSeconds(new Date(), action.display.duration_remaining).toISOString();
        }
        return null;
    };
    ...
    HtAction.prototype.getHeatLatlngs = function (items) {
        return underscore_1.default.reduce(items, function (acc, place) {
...
exports.htAction = function (action) { return new HtAction(action); };
