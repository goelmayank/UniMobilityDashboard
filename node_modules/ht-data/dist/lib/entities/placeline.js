...
var HtPlaceline = (function () {
    ...
    HtPlaceline.prototype.createEventMark = function (event) {
        return { event: event, display: event_1.htEvent().getEventDisplay(event) };
    };
    ...
    HtPlaceline.prototype.isLive = function (placeline) {
        ...
        return status !== "Tracking stopped" && old < 15 * 60 && date_fns_1.isToday(new Date(date));
    };
    HtPlaceline.prototype.getSegmentTypes = function (userSegments) {
        return underscore_1.default.reduce(userSegments, function (segmentType, segment) {
