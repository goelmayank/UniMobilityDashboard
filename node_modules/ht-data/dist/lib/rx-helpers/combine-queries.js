...
exports.CombineQueries = function (addQueries$) {
    return function (query$) {
        if (addQueries$ && addQueries$.length) {
            return combineLatest_1.combineLatest.apply(void 0, [query$].concat(addQueries$.filter(function (data) { return !!data; }), [function (query) {
                    var addQueries = [];
