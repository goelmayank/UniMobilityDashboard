(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ht-client'), require('@angular/core'), require('ht-maps'), require('ht-api'), require('@angular/common/http'), require('@angular/animations'), require('ht-utility'), require('ht-data'), require('@angular/common'), require('@angular/router'), require('underscore'), require('rxjs/operators'), require('rxjs/observable/merge'), require('rxjs/observable/of'), require('rxjs/Subject'), require('rxjs/BehaviorSubject'), require('date-fns'), require('rxjs/observable/combineLatest'), require('frappe-charts/dist/frappe-charts.min.esm'), require('rxjs/Observable'), require('rxjs/observable/timer'), require('rxjs/ReplaySubject'), require('popper.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'ht-client', '@angular/core', 'ht-maps', 'ht-api', '@angular/common/http', '@angular/animations', 'ht-utility', 'ht-data', '@angular/common', '@angular/router', 'underscore', 'rxjs/operators', 'rxjs/observable/merge', 'rxjs/observable/of', 'rxjs/Subject', 'rxjs/BehaviorSubject', 'date-fns', 'rxjs/observable/combineLatest', 'frappe-charts/dist/frappe-charts.min.esm', 'rxjs/Observable', 'rxjs/observable/timer', 'rxjs/ReplaySubject', 'popper.js'], factory) :
	(factory((global['ht-angular'] = {}),global.htClient,global.ng.core,global.htMaps,global.htApi,global.ng.common.http,global.ng.animations,global.htUtility,global.htData,global.ng.common,global.ng.router,global._,global.Rx.operators,global.Rx.Observable,global.Rx.Observable,global.Rx,global.Rx,global.dateFns,global.Rx.Observable,global.Chart,global.Rx,global.Rx.Observable,global.Rx,global.Popper));
}(this, (function (exports,htClient,core,htMaps,htApi,http,animations,htUtility,htData,common,router,underscore,operators,merge,of,Subject,BehaviorSubject,dateFns,combineLatest,Chart,Observable,timer,ReplaySubject,Popper) { 'use strict';
...
var MAP_KEY = new core.InjectionToken('app.mapKey');
var BASE_URL = new core.InjectionToken('app.baseUrl');
function requestServiceFactory(http$$1, token, baseUrl) {
    var request = new HtRequestService(http$$1, token);
    if (baseUrl)
        request.baseUrl = baseUrl;
    return request;
}
function clientServiceFactory(token, request) {
    var client = htClient.htClientService.getInstance(token, request);
    return client;
}
    ...
    HtModule.forRoot = function (config) {
        return {
            ...
            providers: [
                ...
                { provide: HtRequestService, useFactory: requestServiceFactory, deps: [http.HttpClient, TOKEN, BASE_URL] },
...
HtModule.ctorParameters = function () { return [
    { type: undefined, decorators: [{ type: core.Inject, args: [TOKEN,] },] },
...
UsersSummaryContainerComponent.propDecorators = {
    ...
    "clearDataOnDestroy": [{ type: core.Input },],
    "toSetActive": [{ type: core.Input },],
};
...
var UsersContainerComponent = /** @class */ (function () {
    ...
    UsersContainerComponent.prototype.ngOnInit = function () {
        ...
        if (this.hasPlaceline) {
            var selectedUser$ = htData.listwithSelectedId$(this.userService.list.data$, this.userService.list.id$);
...
var PlacelineComponent = /** @class */ (function () {
    ...
    Object.defineProperty(PlacelineComponent.prototype, "placelineMod", {
        get: function () {
            ...
            var activitySegments = underscore.reduce(this.userData.segments, function (acc, segment) {
                ...
                var events = underscore.reject(acc.events, function (event) {
            ...
            var _b = underscore.reduce(__spread(activitySegments, [lastSeg]), function (acc, segment, i, placelineM) {
                ...
                var actionEvents = underscore.reject(acc.actionEvents, function (actionEvent) {
            ...
            var currentSegment = underscore.sortBy(unsortedCurrentSegment, function (segment) {
                return segment.time;
            });
            var restActiviySegments = underscore.map(actionEvents, function (actionEvent, i) {
            ...
            var expActionSegments = underscore.map(expActions, function (actionEvent, i, expEvents) {
    ...
    PlacelineComponent.prototype.currentExpActions = function (actions) {
        ...
        return underscore.reduce(actions, function (acc, action) {
            ...
            var assign = Object.assign({ actionText: htUtility.NameCase(action.type) + " assigned", actionTime: action.assigned_at, actionD: htUtility.NameCase(action.type[0]) + _this.actionMap[action.id], action_id: action.id, actionLookupId: action.lookup_id }, action);
    ...
    PlacelineComponent.prototype.lastSeg = function (placeline) {
        var lastSeg = underscore.last(placeline.segments);
        if (!lastSeg)
            return {};
        var pipeClass = "";
        var time;
        var isLive = new htData.HtPlaceline().isLive(placeline);
        if (!isLive) {
...
var PaginationComponent = /** @class */ (function () {
    ...
    Object.defineProperty(PaginationComponent.prototype, "currentPage", {
        get: function () {
            ...
            var page = 1;
            if (preUrl) {
                var prevPage = htUtility.GetUrlParam('page', this.pageDate.previous) || 1;
                page = +prevPage + 1;
            }
            return page;
        },
...
MapComponent.propDecorators = {
    ...
    "resetCta": [{ type: core.ViewChild, args: ['resetCta', { read: core.ViewContainerRef },] },],
    "reset": [{ type: core.ContentChild, args: ['reset',] },],
...
var UsersFilterComponent = /** @class */ (function () {
    ...
    UsersFilterComponent.prototype.ngOnInit = function () {
        ...
        this.showFilter$ = this.usersClient.list.id$.pipe(operators.map(function (id) { return !id ? 'show' : 'hide'; }));
    };
...
UsersFilterComponent.ctorParameters = function () { return [
    { type: HtUsersService, decorators: [{ type: core.Optional },] },
    { type: core.ChangeDetectorRef, },
]; };
UsersFilterComponent.propDecorators = {
    "usersClient": [{ type: core.Input },],
    "options": [{ type: core.Input },],
};
...
var DateRangePickerComponent = /** @class */ (function () {
    function DateRangePickerComponent() {
        ...
        this.customDates = htData.DateRangeLabelMap;
        var monthStart = dateFns.startOfMonth(new Date());
    ...
    DateRangePickerComponent.prototype.changeMonth = function (inc) {
        var month = dateFns.addMonths(new Date(this.currentMonthStart$.getValue()), inc);
...
var UsersListContainerComponent = /** @class */ (function () {
    function UsersListContainerComponent() {
        this.dateRangeService = new htClient.DateRange(htData.DateRangeMap.today);
        this.date = htData.DateRangeMap.today.start;
    }
...
var UsersAnalyticsListService = /** @class */ (function () {
    ...
    UsersAnalyticsListService.prototype.initClient = function (config) {
        var _this = this;
        var userClient = htClient.usersClientFactory({ dateRange: this.dateRangeService$ });
...
var UsersSummaryService = /** @class */ (function () {
    ...
    UsersSummaryService.prototype.setState = function (config) {
        ...
        this.title = config.title;
        var client = config.client || htClient.usersClientFactory({ dateRange: this.dateRangeService$ });
        client.setShowAll();
...
var StopsHeatmapService = /** @class */ (function () {
    ...
    StopsHeatmapService.prototype.initClient = function (config) {
        ...
        var heatMapTrace = new htMaps.StopsHeatmapTrace(this.mapInstance);
...
var ActionsStatusGraphService = /** @class */ (function () {
    ...
    ActionsStatusGraphService.prototype.initClient = function () {
        var _this = this;
        var graphClient = htClient.actionsClientFactory({ dateRange: this.dateRangeService$ });
...
var ActionsAnalyticsListService = /** @class */ (function () {
    ...
    ActionsAnalyticsListService.prototype.initClient = function (config) {
        var _this = this;
        var userClient = htClient.actionsClientFactory({ dateRange: this.dateRangeService$ });
        this.client = userClient.list;
        this.client.updateStrategy = config.updateStrategy || "once";
        this.client.setQuery(this.query);
        this.loading$ = this.client.loading$;
...
var ActionsSummaryService = /** @class */ (function () {
    ...
    ActionsSummaryService.prototype.initState = function (config) {
        ...
        this.title = config.title;
        var client = config.client || htClient.actionsClientFactory({ dateRange: this.dateRangeService$ });
...
var ActionsHeatmapService = /** @class */ (function () {
    ...
    ActionsHeatmapService.prototype.initClient = function (config) {
        ...
        this.dateRangeService$ = htClient.dateRangeFactory(config.initialDateRange || htData.DateRangeMap.last_7_days);
        this.title = config.title;
        var actionsClient = htClient.actionsClientFactory({ dateRange: this.dateRangeService$ });
        this.client = actionsClient.heatmap;
        this.mapLoading$ = this.client.loading$;
        this.data$ = this.client.data$.pipe(operators.tap(function (data) {
            _this.noData = data && data.count == 0 ? true : false;
        }));
        var heatMapTrace = new htMaps.ActionsHeatmapTrace(this.mapInstance);
        heatMapTrace.setPageData$(this.data$);
    };
...
var AnalyticsItemsService = /** @class */ (function () {
    function AnalyticsItemsService() {
        ...
        var usersClient = htClient.usersClientFactory({ dateRange: htClient.dateRangeFactory(htData.DateRangeMap.today) });
        ...
        var actionDateRangeService = htClient.dateRangeFactory(htData.DateRangeMap.today);
        var actionsClient = htClient.actionsClientFactory({ dateRange: actionDateRangeService });
        this.presets = [
...
var TrackingService = /** @class */ (function () {
    function TrackingService() {
        ...
        this.actions$ = new ReplaySubject.ReplaySubject();
        this.error$ = new ReplaySubject.ReplaySubject();
        this.setTrackApi();
    }
    TrackingService.prototype.setTrackApi = function () {
        var request = htApi.htRequestService.getInstance(HTPublishableKey);
        request.setClientType('hypertrack/trct.at');
        this.trackApi = new htApi.HtTrackingApi(request);
    };
    TrackingService.prototype.initShortCode = function (shortCode) {
        var _this = this;
        this.trackApi.track(shortCode).pipe(operators.tap(function (data) {
        }), operators.expand(function (data) {
            return timer.timer(2000).pipe(operators.concatMap(function (_) {
                return _this.trackApi.track(shortCode).pipe(operators.catchError(function (err) {
...
var TrackingMapService = /** @class */ (function () {
    function TrackingMapService(mapService) {
        this.mapService = mapService;
        this.dirty$ = new BehaviorSubject.BehaviorSubject(false);
    ...
    TrackingMapService.prototype.setData$ = function (actionsData$) {
        ...
        if (!this.actionsTrace)
            this.actionsTrace = new htMaps.ActionTrace(mapInstance, { hasPulse: true });
        this.setStyle();
...
var TrackingComponent = /** @class */ (function () {
    ...
    TrackingComponent.prototype.ngOnInit = function () {
        ...
        this.popups$ = this.actionsData$.pipe(operators.map(function (data) {
        ...
        this.userPopup$ = this.actionsData$.pipe(operators.debounceTime(100), operators.map(function (data) {
        ...
        var completedAction$ = this.actionsData$.pipe(operators.filter(function (data) {
            return !!data && data.length && data[0].display.show_summary;
        }), operators.take(1));
        this.actionsData$.pipe(operators.filter(function (data) { return !!data && data.length && !data[0].display.show_summary; }), operators.takeUntil(completedAction$)).subscribe(function (action) {
            _this.loading = false;
        ...
        this.startPopup$ = completedAction$.pipe(operators.map(function (data) {
    ...
    { type: core.Component, args: [{
                ...
                animations: [
                    animations.trigger('fade', [
                        animations.transition(":leave", [
                            animations.animate('300ms ease-in', animations.style({ transform: "translateY(100%)" }))
                        ])
                    ])
                ]
            },] },
    ...
    { type: core.Component, args: [{
                ...
                animations: [
                    animations.trigger('appear', [
                        animations.transition(":enter", [
                            animations.style({ transform: "translateY(100px)" }),
                            animations.animate('300ms ease-out', animations.style({ transform: "*" }))
                        ])
                    ])
                ]
            },] },
...
PopperContent.propDecorators = {
    "referenceObject": [{ type: core.Input },],
...
InfoboxComponent.propDecorators = {
    "popper": [{ type: core.ViewChild, args: [PopperContent,] },],
    "item": [{ type: core.Input },],
};
...
PopperController.propDecorators = {
    ...
    "forceDetection": [{ type: core.Input, args: ['popperForceDetection',] },],
    "popperOnShown": [{ type: core.Output },],
    "popperOnHidden": [{ type: core.Output },],
    "showOrHideOnClick": [{ type: core.HostListener, args: ['touchstart',] }, { type: core.HostListener, args: ['click',] },],
    "showOrHideOnMouseOver": [{ type: core.HostListener, args: ['touchstart',] }, { type: core.HostListener, args: ['mousedown',] },],
    "showOnHover": [{ type: core.HostListener, args: ['mouseenter',] },],
    "hideOnLeave": [{ type: core.HostListener, args: ['touchend',] }, { type: core.HostListener, args: ['touchcancel',] }, { type: core.HostListener, args: ['mouseleave',] },],
};
var ɵ0 = {};
...
exports.HtAccountService = HtAccountService;
exports.HtActionsService = HtActionsService;
exports.UsersSummaryContainerModule = UsersSummaryContainerModule;
exports.UsersSummaryContainerComponent = UsersSummaryContainerComponent;
...
exports.UsersListContainerModule = UsersListContainerModule;
...
exports.ɵci = ActionStatusComponent;
exports.ɵch = ActionStatusModule;
exports.ɵcc = ActionSummaryComponent;
exports.ɵcb = ActionSummaryModule;
...
exports.ɵbe = DataTableComponent;
exports.ɵbd = DataTableModule;
exports.ɵce = DestinationPopupComponent;
exports.ɵcd = DestinationPopupModule;
exports.ɵbb = EntitySearchComponent;
exports.ɵba = EntitySearchModule;
exports.ɵbc = UsersFilterComponent;
exports.ɵz = UsersFilterModule;
exports.ɵbg = GroupsChartService;
exports.ɵa = MAP_TYPE;
exports.ɵb = HtRequestService;
exports.ɵcr = InfoboxComponent;
exports.ɵcl = InfoboxModule;
exports.ɵy = MapComponent;
exports.ɵs = ActionSortingStringPipe;
exports.ɵp = ActionStatusStringPipe;
exports.ɵl = DateHumanizePipe;
exports.ɵf = DateStringPipe;
exports.ɵm = DistanceLocalePipe;
exports.ɵh = DotPipe;
exports.ɵn = HmStringPipe;
exports.ɵi = NameCasePipe;
exports.ɵt = PluralizePipe;
exports.ɵq = SafeUrlPipe;
exports.ɵg = TimeStringPipe;
exports.ɵr = UserSortingStringPipe;
exports.ɵo = UsersStatusStringPipe;
exports.ɵcp = PopperContent;
exports.ɵcn = PopperController;
exports.ɵcm = PopperModule;
exports.ɵcq = PopperService;
exports.ɵe = BatteryIconComponent;
exports.ɵu = ButtonComponent;
exports.ɵw = DropdownDirective;
exports.ɵv = LoadingBarComponent;
exports.ɵk = LoadingDataComponent;
exports.ɵj = LoadingDotsComponent;
exports.ɵd = ProfileComponent;
exports.ɵck = StartPopupComponent;
exports.ɵcj = StartPopupModule;
exports.ɵbz = TrackingMapComponent;
exports.ɵby = TrackingMapModule;
exports.ɵca = TrackingMapService;
exports.ɵcs = TrackingComponent;
exports.ɵct = TrackingService;
exports.ɵcg = UserPopupComponent;
exports.ɵcf = UserPopupModule;
exports.ɵbf = UsersListContainerComponent;
exports.ɵx = UsersSummaryComponent;
exports.ɵc = UsersSummaryModule;
