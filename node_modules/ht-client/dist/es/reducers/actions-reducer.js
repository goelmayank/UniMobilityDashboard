...
;
export var getList = function (state) { return state.list; };
export var getListLoading = function (state) { return state.listLoading; };
...
export var getSummaryActive = function (state) { return state.summaryActive; };
export var getSummaryQuery = function (state) { return state.summaryQuery; };
export var getSummaryLoading = function (state) { return state.summaryLoading; };
export var getGraph = function (state) { return state.graph; };
export var getGraphQuery = function (state) { return state.graphQuery; };
export var getGraphLoading = function (state) { return state.graphLoading; };
