(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('rxjs/operators'), require('rxjs/observable/timer'), require('ht-data'), require('rxjs/observable/combineLatest'), require('rxjs/observable/of'), require('rxjs/observable/empty'), require('ht-utility'), require('rxjs/BehaviorSubject'), require('rxjs/Observable'), require('rxjs/Subject'), require('rxjs/operator/observeOn'), require('rxjs/operator/withLatestFrom'), require('rxjs/operator/scan'), require('rxjs/operator/distinctUntilChanged'), require('rxjs/operator/map'), require('rxjs/operator/pluck'), require('rxjs/observable/fromPromise')) :
	typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'rxjs/operators', 'rxjs/observable/timer', 'ht-data', 'rxjs/observable/combineLatest', 'rxjs/observable/of', 'rxjs/observable/empty', 'ht-utility', 'rxjs/BehaviorSubject', 'rxjs/Observable', 'rxjs/Subject', 'rxjs/operator/observeOn', 'rxjs/operator/withLatestFrom', 'rxjs/operator/scan', 'rxjs/operator/distinctUntilChanged', 'rxjs/operator/map', 'rxjs/operator/pluck', 'rxjs/observable/fromPromise'], factory) :
	(factory((global.htClient = {}),global['-'],global.Rx.operators,global.Rx.Observable,global.htData,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.htUtility,global.Rx,global.Rx,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable));
}(this, (function (exports,_,operators,timer,htData,combineLatest,of,empty,htUtility,BehaviorSubject,Observable,Subject,observeOn,withLatestFrom,scan,distinctUntilChanged$1,map$2,pluck$1,fromPromise) { 'use strict';
...
var initialState = {
    ...
    listApiType: exports.ApiType.analytics,
    ...
    switch (action.type) {
        ...
        case ADD_USERS_ANALYTICS_ALL: {
            ...
            if (state.usersAnalyticsAll) {
                resultsEntity = __assign$1({}, state.usersAnalyticsAll.resultsEntity, _.indexBy(action.payload.results, "id"));
            }
...
function getIdQueryDataMixin(Base) {
    return (function (_super) {
        ...
        class_1.prototype.getData$ = function (_a) {
            ...
            var update = this.getFirstData$([id, query]).pipe(operators.expand(function (data) {
                return timer.timer(_this.pollDuration).pipe(operators.switchMap(function () {
...
function getPageDataMixin(Base) {
    return (function (_super) {
        ...
        class_2.prototype.getData$ = function (_a) {
            var _this = this;
            var query = _a[0];
            var update = this.getFirstData$([query]).pipe(operators.expand(function (data) {
                return timer.timer(_this.pollDuration).pipe(operators.switchMap(function () {
                    if (_this.updateStrategy == "live") {
                        ...
                        return _this.api$(updateQuery).pipe(operators.map(function (newData) {
...
function listQueryMixin(Base) {
    return (function (_super) {
        ...
        class_1.prototype.getApiQuery$ = function () {
            return this.getApiParams$().pipe(operators.map(function (data) {
                return data[0];
            }));
        };
        class_1.prototype.getBaseQuery$ = function () {
            var baseQuery$ = this.query$.pipe(htData.AllowedQueryMap(this.allowedQueryMap), MergeQuery(this.getDefaultQuery()), htData.CombineQueries([this.dateRange.data$.pipe(htData.DateRangeToQuery$(this.dateParam)) || of.of({})]));
            return baseQuery$;
        };
        class_1.prototype.getApiParams$ = function () {
            var baseQuery$ = this.getBaseQuery$().pipe(operators.map(function (data) {
                return [data];
            }));
            return this.active$
                ? this.active$.pipe(operators.switchMap(function (isActive) {
                    // console.log(isActive, "accc");
                    return isActive ? baseQuery$ : of.of([]);
                }))
                : baseQuery$;
        };
        return class_1;
...
function itemQueryMixin(Base) {
    return (function (_super) {
        ...
        class_2.prototype.getApiParams$ = function () {
            return combineLatest.combineLatest(this.id$, this.query$.pipe(MergeQuery(this.getDefaultQuery())));
        };
        return class_2;
    }(Base));
}
...
function getFirstDataMixin(Base) {
    return (function (_super) {
        ...
        class_1.prototype.getFirstData$ = function (args) {
            var _this = this;
            var entity = this;
            return entity.api$.apply(entity, args).pipe(operators.tap(function (data) {
...
var UsersAnalytics = (function (_super) {
    ...
    function UsersAnalytics(_a) {
        ...
        _this.dataArray$ = _this.data$.pipe(htData.PageResults$);
        return _this;
        // this.init()
    }
...
var EntityClient = (function () {
    ...
    EntityClient.prototype.dataArrayWithSelected$ = function (id$, dataArray$, selected$) {
        var userId$ = id$;
        var placelinePage$ = selected$.pipe(operators.distinctUntilChanged(), operators.map(function (data) {
            return data ? [data] : null;
        })); //todo take query from placeline
        var array$ = combineLatest.combineLatest(placelinePage$, userId$, dataArray$, function (placelinePage, userId, dataArray) {
    ...
    EntityClient.prototype.pageDataWithSelected$ = function (id$, pageData$, selected$) {
        // const userId$ = id$;
        var placelinePage$ = selected$.pipe(htData.itemAsPage$());
        var newPageData$ = combineLatest.combineLatest(placelinePage$, id$, pageData$, function (placelinePage, userId, pageData) {
            if (!pageData)
                return pageData;
...
var EntityAllItemsClient = (function (_super) {
    ...
    EntityAllItemsClient.prototype.getMarkers$ = function () {
        return this.getAllMarkers$().pipe(operators.pluck("valid"));
    };
...
var UsersAnalyticsListAll = (function (_super) {
    ...
    UsersAnalyticsListAll.prototype.isValidMarker = function (marker) {
        return htData.htUser(marker).isValidMarker();
    };
...
var BaseFilter = (function () {
    ...
    BaseFilter.prototype.summaryCharts = function (queryLabels, data, status) {
        if (data) {
            var max_1;
            var total_1 = 0;
            var values$$1 = _.map(queryLabels, function (entity) {
            ...
            var chart = _.map(values$$1, function (datum) {
                var selected = false;
...
var State = (function (_super) {
    ...
    function State(actions$, reducer$, scannedActions, initialState) {
        ...
        var actionsOnQueue$ = observeOn.observeOn.call(actions$, queue_1);
...
var Store = (function (_super) {
    ...
    Store.prototype.select = function (pathOrMapFn) {
        ...
        if (typeof pathOrMapFn === "string") {
            mapped$ = pluck$1.pluck.call.apply(pluck$1.pluck, [this, pathOrMapFn].concat(paths));
        }
        else if (typeof pathOrMapFn === "function") {
            mapped$ = map$2.map.call(this, pathOrMapFn);
        }
        else {
            throw new TypeError("Unexpected type '" + typeof pathOrMapFn + "' in select operator," +
                " expected 'string' or 'function'");
        }
        return distinctUntilChanged$1.distinctUntilChanged.call(mapped$);
    };
...
var defaultDateRange = __assign$14({}, htData.DateRangeMap.today);
var DateRange = (function () {
    function DateRange(initialDate) {
        if (initialDate === void 0) { initialDate = {}; }
        this.dataBehaviour$ = new BehaviorSubject.BehaviorSubject(__assign$14({}, defaultDateRange, initialDate));
    ...
    Object.defineProperty(DateRange.prototype, "display$", {
        get: function () {
            return this.data$.pipe(operators.map(function (range) {
                return htUtility.dateRangeDisplay(range);
            }));
        },
        enumerable: true,
        configurable: true
...
var UsersHeatmap = (function () {
    function UsersHeatmap(_a) {
        ...
        this.query$ = of.of({});
        this.loadingState$ = new BehaviorSubject.BehaviorSubject(false);
        this.loading$ = this.loadingState$.asObservable();
        this.dataState$ = new BehaviorSubject.BehaviorSubject(null);
        this.data$ = this.dataState$.asObservable();
        this.active$ = new BehaviorSubject.BehaviorSubject(false);
        this.dataArray$ = this.data$.pipe(htData.PageResults$);
...
var HtBaseApi = (function () {
    ...
    HtBaseApi.prototype.allPages = function (api$, options) {
        ...
        return api$.pipe(operators.expand(function (data) {
            return data["next"]
                ? _this.request.api$(data["next"], {}, __assign$1$1({}, options, { pureUrl: true })).pipe(operators.map(function (newData) {
...
var HtActionsApi = (function (_super) {
    ...
    HtActionsApi.prototype.graph = function (query, token) {
        ...
        return this.api$(path, query, { token: token }).pipe(operators.map(function (obj) {
...
var HtTrackingApi = (function (_super) {
    ...
    HtTrackingApi.prototype.track = function (id, idType, token) {
        ...
        if (trackKey) {
            ...
            return this.api$(path, query, { token: token }).pipe(operators.map(function (data) {
                var actions = [];
...
var HtUsersClient = (function (_super) {
    ...
    HtUsersClient.prototype.getLoading$ = function () {
        return htData.CombineLoadings$(this.list.loading$, this.summary.loading$);
    };
    ...
    HtUsersClient.prototype.getInitialDateRange = function (range) {
        ...
        var initialRange = htData.DateRangeMap.today;
        return __assign({}, range, initialRange);
    };
    HtUsersClient.prototype.listStatusOverview$ = function () {
        return this.summary.data$.pipe(operators.map(function (summary) {
            if (summary) {
    ...
    HtUsersClient.prototype.listStatusChart$ = function (queryLabels) {
        ...
        return combineLatest.combineLatest(this.list.query$, this.listStatusOverview$()).pipe(operators.map(function (_a) {
            ...
            if (overview) {
                ...
                var values$$1 = _.map(summaryEntity, function (entity) {
                    var sum = _.reduce(entity.values, function (acc, key) {
    ...
    Object.defineProperty(HtUsersClient.prototype, "ordering$", {
        get: function () {
            var _this = this;
            return this.list.getApiQuery$().pipe(filter_2(function (data) { return !!data; }), operators.map(function (query) {
    ...
    HtUsersClient.prototype.getCurrentPlaceline$ = function () {
        return combineLatest.combineLatest(this.placeline.data$, this.getSegmentsStates(), function (userData, _a) {
    ...
    HtUsersClient.prototype.initEffects = function () {
        ...
        }, { isSame: false, oldId: null }), operators.pluck("isSame"), filter_2(function (data) { return !data; }))
    ...
    HtUsersClient.prototype.setListAllFilter = function (query) {
        ...
        if (statusString) {
            ...
            statusArray.forEach(function (status) {
                statusFilter_1.push(htData.htUser().getMarkerFilter(status));
            });
            var allStatusFilter = function (user) {
                return _.reduce(statusFilter_1, function (acc, filter$$1) {
        ...
        if (search) {
            userMarkerFilters.push(function (user) {
                return htData.htUser().getMarkerSearched(search)(user); // || userMarkerFilter(user)
            });
            // this.updateUserMap(query);
        }
        if (ids) {
        ...
        var userMarkerFilter = function (user) {
            return _.reduce(userMarkerFilters, function (acc, filter$$1) {
                return acc && filter$$1(user);
            }, true);
        };
    ...
    HtUsersClient.prototype.getListAllUpdateQuery$ = function (overview, query) {
        return this.listAll.data$.pipe(operators.flatMap(function (allData) {
            var results = _.values(allData.resultsEntity);
            ...
            if (!!status) {
                ...
                return value && value !== currentTotalUsers ? of.of(true) : empty.empty();
            }
...
var GroupsItem = (function (_super) {
    ...
    function GroupsItem(_a) {
        ...
        _this.updateStrategy = "once";
        _this.query$ = of.of({});
        _this.data$ = empty.empty();
        _this.loading$ = of.of(false);
...
var HtGroupsClient = (function (_super) {
    ...
    HtGroupsClient.prototype.key$ = function (id) {
        return this.api.get(id).pipe(operators.map(function (group) {
            return group["token"];
        }));
    };
    HtGroupsClient.prototype.lookupIdKey$ = function (lookupId) {
        return this.api.index({ lookup_id: lookupId }).pipe(operators.map(function (groupPage) {
...
var ActionsGraph = (function () {
    function ActionsGraph(_a) {
        var dateRange = _a.dateRange, store = _a.store, dateParam = _a.dateParam, api = _a.api;
        this.query$ = of.of({});
        this.dataBehaviour$ = new BehaviorSubject.BehaviorSubject(null);
        this.data$ = this.dataBehaviour$.asObservable();
        this.loadingBehaviour$ = new BehaviorSubject.BehaviorSubject(false);
...
var ActionsSummary = (function (_super) {
    ...
    ActionsSummary.prototype.getSummaryChart = function () {
        var _this = this;
        return this.data$.pipe(operators.map(function (summaryData) {
...
var ActionsIndexAll = (function (_super) {
    ...
    function ActionsIndexAll(_a) {
        var dateRange = _a.dateRange, store = _a.store, dateParam = _a.dateParam, api = _a.api;
        var _this = _super.call(this) || this;
        _this.dataBehaviour$ = new BehaviorSubject.BehaviorSubject(null);
        _this.loadingBehaviour$ = new BehaviorSubject.BehaviorSubject(false);
        _this.loading$ = _this.loadingBehaviour$.asObservable();
        _this.activeBehaviour$ = new BehaviorSubject.BehaviorSubject(false);
        _this.api$ = function (query) { return api.allPages(api.index(query)); };
        _this.dateRange = dateRange;
        _this.dateParam = dateParam;
        _this.query$ = new BehaviorSubject.BehaviorSubject(_this.getDefaultQuery());
...
exports.defaultListConfig = defaultListConfig;
exports.HtUsersClient = HtUsersClient;
exports.usersClientFactory = usersClientFactory;
exports.UsersPlaceline = UsersPlaceline;
exports.UsersPlacelineClient = UsersPlacelineClient;
exports.UsersAnalytics = UsersAnalytics;
exports.UsersAnalyticsClient = UsersAnalyticsClient;
exports.UsersAnalyticsListAll = UsersAnalyticsListAll;
exports.UsersAnalyticsListAllClient = UsersAnalyticsListAllClient;
exports.UsersSummary = UsersSummary;
exports.UsersSummaryClient = UsersSummaryClient;
exports.UsersHeatmap = UsersHeatmap;
exports.UsersHeatmapClient = UsersHeatmapClient;
exports.DefaultUsersFilter = DefaultUsersFilter;
exports.ActionsFilter = ActionsFilter;
exports.HtGroupsClient = HtGroupsClient;
exports.groupsClientFactory = groupsClientFactory;
exports.GroupsList = GroupsList;
exports.GroupsListClient = GroupsListClient;
exports.GroupsItem = GroupsItem;
exports.GroupsItemClient = GroupsItemClient;
exports.AccountsClient = AccountsClient;
exports.AccountUser = AccountUser;
exports.AccountUserClient = AccountUserClient;
exports.MembershipsAll = MembershipsAll;
exports.MemberShipsClient = MemberShipsClient;
exports.HtActionsClient = HtActionsClient;
exports.actionsClientFactory = actionsClientFactory;
exports.ActionsGraph = ActionsGraph;
exports.ActionsGraphClient = ActionsGraphClient;
exports.ActionsList = ActionsList;
exports.ActionsListClient = ActionsListClient;
exports.ActionsSummary = ActionsSummary;
exports.ActionsSummaryClient = ActionsSummaryClient;
exports.ActionsHeatmap = ActionsHeatmap;
exports.ActionsHeatmapClient = ActionsHeatmapClient;
exports.defaultDateRange = defaultDateRange;
exports.DateRange = DateRange;
exports.dateRangeFactory = dateRangeFactory;
exports.dateRangeService = dateRangeService;
exports.HtClient = HtClient;
exports.initClient = initClient;
exports.htClientFactory = htClientFactory;
exports.htClientService = htClientService;
exports.reducers = reducers;
exports.reducer = reducer;
exports.metaReducers = metaReducers;
exports.getUsersState = getUsersState;
exports.getUsersUsersData = getUsersUsersData;
exports.getUsersPlacelineId = getUsersPlacelineId;
exports.getUsersPlacelineQuery = getUsersPlacelineQuery;
exports.getUsersPlacelineLoading = getUsersPlacelineLoading;
exports.getUsersListActive = getUsersListActive;
exports.getUsersListId = getUsersListId;
exports.getUsersListQuery = getUsersListQuery;
exports.getUsersAnalyticsPage = getUsersAnalyticsPage;
exports.getUsersAnalyticsLoading = getUsersAnalyticsLoading;
exports.getUsersIndexPage = getUsersIndexPage;
exports.getUsersIndexIsActive = getUsersIndexIsActive;
exports.getUsersAnalyticsIsActive = getUsersAnalyticsIsActive;
exports.getUsersIndexMarkersIsActive = getUsersIndexMarkersIsActive;
exports.getUsersAnalyticsMarkersIsActive = getUsersAnalyticsMarkersIsActive;
exports.getUsersAnalyticsAllLoading = getUsersAnalyticsAllLoading;
exports.getUsersIndexFilteredMarker = getUsersIndexFilteredMarker;
exports.getUsersAnalyticsFilteredMarker = getUsersAnalyticsFilteredMarker;
exports.getUsersIndexAll = getUsersIndexAll;
exports.getUsersAnalyticsAll = getUsersAnalyticsAll;
exports.getUsersSummary = getUsersSummary;
exports.getUsersSummaryActive = getUsersSummaryActive;
exports.getUsersSummaryLoading = getUsersSummaryLoading;
exports.getSegmentsState = getSegmentsState;
exports.getSegmentsSelectedId = getSegmentsSelectedId;
exports.getSegmentsResetMapId = getSegmentsResetMapId;
exports.getGroupsState = getGroupsState;
exports.getGroupId = getGroupId;
exports.getGroupAll = getGroupAll;
exports.getGroupListActive = getGroupListActive;
exports.getAccountState = getAccountState;
exports.getAccountUser = getAccountUser;
exports.getAccountMembershipsAll = getAccountMembershipsAll;
exports.getAccountKey = getAccountKey;
exports.getAccountTempKey = getAccountTempKey;
exports.getAccountCurrentKey = getAccountCurrentKey;
exports.getAccountUserId = getAccountUserId;
exports.getActionsState = getActionsState;
exports.getActionsList = getActionsList;
exports.getActionsListLoading = getActionsListLoading;
exports.getActionsListActive = getActionsListActive;
exports.getActionsListQuery = getActionsListQuery;
exports.getActionsSummary = getActionsSummary;
exports.getActionsSummaryActive = getActionsSummaryActive;
exports.getActionsSummaryLoading = getActionsSummaryLoading;
exports.getActionsSummaryQuery = getActionsSummaryQuery;
exports.getActionsGraph = getActionsGraph;
exports.getActionsGraphLoading = getActionsGraphLoading;
exports.getActionsGraphQuery = getActionsGraphQuery;
