...
var UsersAnalytics = (function (_super) {
    ...
    function UsersAnalytics(_a) {
        ...
        _this.dataArray$ = _this.data$.pipe(ht_data_1.PageResults$);
        return _this;
        // this.init()
    }
...
exports.UsersAnalyticsClient = client_subscription_1.clientSubMixin(get_data_1.getPageDataMixin(get_first_data_1.getFirstDataMixin(entity_query_1.listQueryMixin(UsersAnalytics))));
