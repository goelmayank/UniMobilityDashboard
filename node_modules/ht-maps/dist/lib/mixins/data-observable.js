    ...
    return (function (_super) {
        ...
        class_1.prototype._procData$ = function () {
            ...
            return function (source$) {
                return source$.pipe(filter_1.filter(function (data) { return !!data; }), map_1.map(function (pageData) {
        ...
        class_1.prototype.setPageData$ = function (data$, config) {
            ...
            this.dataPageSource$ = hide$
                ? combineLatest_1.combineLatest(data$, hide$.pipe(distinctUntilChanged_1.distinctUntilChanged()), function (data, hide) {
        ...
        class_1.prototype.setData$ = function (data$, config) {
            ...
            this.dataArraySource$ = hide$
                ? combineLatest_1.combineLatest(data$, hide$.pipe(distinctUntilChanged_1.distinctUntilChanged()), function (data, hide) { return (!!hide ? [] : data); })
                : data$;
            this.data$ = this.dataArraySource$.pipe(scan_1.scan(function (acc, data) {
                return { new: data, old: acc.new };
            }, { old: null, new: null }), map_1.map(function (dataArray) {
        ...
        class_1.prototype._initDataObserver = function () {
            var _this = this;
            var mapData$ = this.data$.pipe(filter_1.filter(function (data) { return !!_this.mapInstance.map; }));
            var render$ = combineLatest_1.combineLatest(mapData$, this.mapInstance.map$.pipe(filter_1.filter(function (data) { return !!data; })), function (mapData, map) { return mapData; });
