...
var position_time_helper_1 = require("../helpers/position-time-helper");
    ...
    return (function (_super) {
        ...
        class_1.prototype.update = function (_a, pathBearing) {
            ...
            if (this.getPath || pathBearing) {
                ...
                this.positionTimeArray = position_time_helper_1.positionTime.decode(this.getEncodedPositionTime(data));
