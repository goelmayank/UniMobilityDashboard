...
var map_type_1 = require("../global/map-type");
var MapInstance = (function () {
    function MapInstance() {
        var _this = this;
        // mapUtils: MapUtils = null;
        this.map = null;
        this.map$ = new ReplaySubject_1.ReplaySubject();
        this.clusters = [];
        this.poppers = [];
        this.itemsSet = [];
        // mapType: HtMapType;
    ...
    Object.defineProperty(MapInstance.prototype, "mapUtils", {
        get: function () {
            return map_type_1.mapTypeService.getInstance();
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MapInstance.prototype, "mapType", {
        get: function () {
            return map_type_1.mapTypeService.getInstance().mapType;
        },
        enumerable: true,
        configurable: true
    });
    ...
    MapInstance.prototype.setMapType = function (mapType, key) {
        map_type_1.mapTypeService.getInstance(mapType);
        if (key)
    ...
    MapInstance.prototype.addCluster = function (cluster) {
        ...
        if (!this.clusters.includes(cluster)) {
            ...
            this.map$.pipe(operators_1.filter(function (data) { return !!data; }))
    ...
    MapInstance.prototype.listenMove = function () {
        var _this = this;
        this.map$.pipe(operators_1.filter(function (data) { return !!data; }), operators_1.take(1)).subscribe(function (map) {
