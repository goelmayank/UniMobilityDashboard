var StyleClass = (function () {
    ...
    StyleClass.prototype.getStyle = function (selectedStyleType, fallbackStyle) {
        ...
        if (!style)
            console.error("style type does not exist ", selectedStyleType);
        return style;
    };
    StyleClass.prototype.setStyleType = function (styleType) {
        if (styleType === void 0) { styleType = 'default'; }
        this.styleType = styleType;
    };
    StyleClass.prototype.setStyle = function (_a) {
    ...
    StyleClass.prototype.getStyleType = function (data) {
    ...
    StyleClass.prototype.setItemStyle = function (item, style) {
