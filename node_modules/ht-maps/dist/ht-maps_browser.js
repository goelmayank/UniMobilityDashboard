(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('rxjs/ReplaySubject'), require('underscore'), require('rxjs/observable/fromEventPattern'), require('leaflet'), require('leaflet.markercluster'), require('leaflet.heat'), require('ht-utility'), require('time-aware-polyline'), require('rxjs/observable/combineLatest'), require('ht-data')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs/operators', 'rxjs/ReplaySubject', 'underscore', 'rxjs/observable/fromEventPattern', 'leaflet', 'leaflet.markercluster', 'leaflet.heat', 'ht-utility', 'time-aware-polyline', 'rxjs/observable/combineLatest', 'ht-data'], factory) :
	(factory((global.htMaps = {}),global.Rx.operators,global.Rx,global['-'],global.Rx.Observable,global.L,global.L,global.L,global.htUtility,global.timeAwarePolyline,global.Rx.Observable,global.htData));
}(this, (function (exports,operators,ReplaySubject,_,fromEventPattern,leaflet,leaflet_markercluster,leaflet_heat,htUtility,timeAwarePolyline,combineLatest,htData) { 'use strict';
...
var GoogleMapUtilsClass = (function () {
    ...
    GoogleMapUtilsClass.prototype.extendBoundsWithPolyline = function (polyline$$1, bounds) {
        ...
        if (polyline$$1 && polyline$$1.getMap()) {
            _.each(polyline$$1.getPath().getArray(), function (p) {
                var l = { lat: p.lat(), lng: p.lng() };
                bounds.extend(l);
            });
        }
    ...
    GoogleMapUtilsClass.prototype.onEvent$ = function (item, type) {
        return fromEventPattern.fromEventPattern(this.mapEventHandler(item, type), this.removeHandler(item, type));
    };
    ...
    GoogleMapUtilsClass.prototype.setPathPositionTimeArray = function (polyline$$1, positionTimeArray) {
        var _this = this;
        var path = _.map(positionTimeArray, function (point) {
...
var leafletHeat = function (latlng, options) {
    if (options === void 0) { options = {}; }
    // console.log(L.MarkerClusterGroup);
    return leaflet.heatLayer(latlng, options);
};
...
var LeafletMapUtilsClass = (function () {
    ...
    LeafletMapUtilsClass.prototype.renderMap = function (elem, options) {
        ...
        var newmap = leaflet.map(elem, options);
        if (options.tileLayerUrl) {
            leaflet.tileLayer(options.tileLayerUrl, options.tileLayerOptions || {}).addTo(newmap);
        }
        return newmap;
    };
    ...
    LeafletMapUtilsClass.prototype.extendItemBounds = function (item, bounds, force) {
        if (item === void 0) { item = null; }
        if (bounds === void 0) { bounds = leaflet.latLngBounds([]); }
        if (force === void 0) { force = false; }
    ...
    LeafletMapUtilsClass.prototype.setDivMarkerStyle = function (item, options) {
        if (options === void 0) { options = {}; }
        var icon = leaflet.divIcon(options);
...
var MapInstance = (function () {
    function MapInstance() {
        ...
        this.map = null;
        this.map$ = new ReplaySubject.ReplaySubject();
        this.clusters = [];
        this.poppers = [];
        this.itemsSet = [];
        // mapType: HtMapType;
    ...
    MapInstance.prototype.addCluster = function (cluster) {
        ...
        if (!this.clusters.includes(cluster)) {
            ...
            this.map$.pipe(operators.filter(function (data) { return !!data; }))
    ...
    MapInstance.prototype.listenMove = function () {
        var _this = this;
        this.map$.pipe(operators.filter(function (data) { return !!data; }), operators.take(1)).subscribe(function (map$$1) {
            ...
            case "google":
                {
                    return {
                        default: {
                            strokeColor: htUtility.Color.blue,
                            strokeOpacity: 1,
                            strokeWeight: 5
                        },
                        highlight: {
                        ...
                        fade: {
                            strokeColor: htUtility.Color.grey5,
                            strokeOpacity: 0.2,
                            strokeWeight: 2
                        }
                    };
...
function ExtendBoundsMixin(Base) {
    return (function (_super) {
        ...
        class_1.prototype.extendBounds = function (bounds) {
            ...
            var newBounds = _.reduce(this.entities, function (bounds, entity) {
...
function MarkersMixin(Base) {
    return (function (_super) {
        ...
        function class_1() {
            ...
            _this.entities = {};
            _this.event = new htUtility.HtCustomEvent();
            return _this;
        }
...
var positionTime = {
    ...
    decode: function (encodedPolyline) {
        this.positionTimePoints = new timeAwarePolyline.TimeAwareEncoder().decodeTimeAwarePolyline(encodedPolyline);
            ...
            case 'google':
                {
                    return {
                        default: {
                            icon: {
                                fillColor: htUtility.Color.stop,
                                fillOpacity: 1,
                                strokeColor: htUtility.Color.stopDark,
                                strokeOpacity: 1,
            ...
            case "leaflet": {
                return {
                    default: {
                        ...
                        fillOpacity: 1,
                        weight: 2,
                        color: htUtility.Color.stopDark,
                        pane: "markerPane"
                    },
                    popup: {
                        offset: [0, -5],
    ...
    return (function (_super) {
        ...
        class_1.prototype.setPageData$ = function (data$, config) {
            ...
            this.dataPageSource$ = hide$
                ? combineLatest.combineLatest(data$, hide$.pipe(distinctUntilChanged_2()), function (data, hide) {
        ...
        class_1.prototype.setData$ = function (data$, config) {
            ...
            this.dataArraySource$ = hide$
                ? combineLatest.combineLatest(data$, hide$.pipe(distinctUntilChanged_2()), function (data, hide) { return (!!hide ? [] : data); })
                : data$;
        ...
        class_1.prototype._initDataObserver = function () {
            ...
            var render$ = combineLatest.combineLatest(mapData$, this.mapInstance.map$.pipe(filter_2(function (data) { return !!data; })), function (mapData, map$$1) { return mapData; });
        ...
        getInfoContent: function (data) {
            ...
            if (data.started_at && data.ended_at) {
                var durationMin = new Date(new Date(data.ended_at).getTime() -
                    ...
                    (1000 * 60);
                durationString = htUtility.HMString(durationMin);
            }
            var start = htUtility.TimeString(data.started_at);
            var end = htUtility.TimeString(data.ended_at);
            var startDate = htUtility.DateString(data.started_at);
            var startDateShort = htUtility.DateString(data.started_at, "short");
            var endDate = htUtility.DateString(data.ended_at);
            var sameDate = startDate == endDate;
            function htShow(item) {
                return "display: " + (item ? "flex" : "none");
            }
            return "<div class=\"flex-column\">\n<strong class=\"text-muted text-center\" style=\"padding-bottom: 0; color: " + htUtility.Color.stop + "\">Stop</strong>\n<div style=\"display: " + (start ? "display" : "none") + "\" class=\"flex-row space-between\">\n    <div>" + (start ||
...
function AnimationMixin(Base) {
    return (function (_super) {
        ...
        class_1.prototype.setTimeAwareAnimation = function (animation) {
            var _this = this;
            this.animation = animation || new timeAwarePolyline.TimeAwareAnimation();
...
var currentUserConfig = {
    renderConfig: {
        getPosition: function (data) {
            return htData.htUser(data).getPosition();
        },
...
function CompoundDataObservableMixin(Base) {
    return (function (_super) {
        ...
        class_1.prototype.setCompoundData$ = function (data$, config) {
            ...
            var dataSource$ = hide$
                ? combineLatest.combineLatest(data$, hide$.pipe(distinctUntilChanged_2()), function (data, hide) { return (!!hide ? null : data); })
                : data$;
            if (config.roots && config.highlighted$) {
                dataSource$ = htData.dataWithSelectedId$(dataSource$, config.highlighted$, config.roots, 'highlightedSegment');
            }
            if (config.roots && filter$)
                dataSource$ = htData.dataWithSelectedId$(dataSource$, filter$, config.roots, 'selectedSegment');
        ...
        class_1.prototype._initDataObserver = function () {
            ...
            var sub = htData.orCombine(newPlaceline$.pipe(filter_2(function (data) { return !!data; })), this.compoundSetDataConfig.resetMap$.pipe(map_2(function (data) { return true; }))).subscribe(function (toReset) {
                if (toReset)
                    _this.mapInstance.resetBounds();
            });
            this.dataSub = sub;
...
var ActionsPolyline = (function (_super) {
                    ...
                    case "google":
                        {
                            return {
                                default: {
                                    strokeColor: htUtility.Color.grey3,
                                    strokeOpacity: 0,
                                    strokeWeight: 5,
                                    icons: [{
                                            icon: {
                                ...
                                highlight: {
                                    strokeColor: htUtility.Color.grey2,
                                    strokeOpacity: 1,
                                    strokeWeight: 5
                                },
                                fade: {
    ...
    ActionsPolyline.prototype.getPathFromData = function (data) {
        return data ? data.actions.reduce(function (path, action) {
            return htData.htAction(action).getExpectedPosition() && !action.completed_at ? path.concat([htData.htAction(action).getPosition()]) : path;
        }, []) : null;
    };
...
var Placeline = (function () {
    function Placeline(options) {
        ...
        this.allowedEvents = {};
        this.anim = new timeAwarePolyline.TimeAwareAnimation();
    ...
    Placeline.prototype.traceAction = function (user, selectedSegment) {
        ...
        var filteredActions = _.filter(actions, function (action) {
            return htData.htAction(action).isValidMarker();
        });
...
var ActionsCluster = (function () {
    ...
    ActionsCluster.prototype.getPosition = function (data) {
        return htData.htAction(data).getPosition();
    };
    ...
    ActionsCluster.prototype.getInfoContent = function (item) {
        ...
        return "<div class=\"flex-column flex-center\" style=\"min-width: 180px\">\n<div class=\"\">\n    <div class=\"text-center\">" + htUtility.NameCase(item.type) + "\n    <span style=\"" + htShow(item.display.duration_remaining && !item.display.show_summary) + "\"> in " + htUtility.HMString(item.display.duration_remaining / 60) + "</span>\n    <span style=\"" + htShow(!!item.completed_at) + "\"> completed at " + htUtility.TimeString(item.completed_at) + "</span>\n   \n    </div>\n</div>\n    <div class=\"text-muted text-center\" style=\"" + htShow(!!item.completed_at) + "\"> " + htUtility.DateString(item.completed_at) + "</div>\n<div class=\"text-center\">" + htUtility.NameCase(userName) + "<span style=\"" + htShow(!!item.lookup_id, 'block') + "\"> | #" + item.lookup_id + "</span></div>\n</div>";
    };
...
var AnimationsEntities = (function () {
    ...
    AnimationsEntities.prototype.getEntity = function (id) {
        ...
        if (entity) {
            ...
            var newEntity = new timeAwarePolyline.TimeAwareAnimation();
...
var ActionUser = (function () {
    ...
    ActionUser.prototype.getPosition = function (data) {
        return htData.htUser(data.user).getPosition();
    };
...
var ActionMap = (function () {
    ...
    ActionMap.prototype.setData$ = function (data$) {
        ...
        if (this.pulse)
            this.pulse.setData$(data$.pipe(operators.map(function (actions) {
                return actions.reduce(function (acc, action) {
                    return action.display.show_summary ? acc : acc.concat([action]);
                }, []);
            })));
        this.user.setData$(data$.pipe(operators.map(function (actions) {
            return actions.reduce(function (acc, action) {
                return action.display.show_summary ? acc : acc.concat([action]);
            }, []);
        })));
...
exports.PlacelineTrace = PlacelineTrace;
exports.HtMapClass = HtMapClass;
exports.mapTypeService = mapTypeService;
exports.mapItemsFactory = mapItemsFactory;
exports.itemsBaseFactory = itemsBaseFactory;
exports.itemsFactory = itemsFactory;
exports.MarkersBase = MarkersBase;
exports.UsersCluster = UsersCluster;
exports.UsersClusterTrace = UsersClusterTrace;
exports.ActionMarkers = ActionMarkers;
exports.ActionMarkersTrace = ActionMarkersTrace;
exports.SegmentPolylines = SegmentPolylines;
exports.SegmentPolylinesTrace = SegmentPolylinesTrace;
exports.stopMarkersConfig = stopMarkersConfig;
exports.stopMarkersTrace = stopMarkersTrace;
exports.StopMarkers = StopMarkers;
exports.StopMarkersTrace = StopMarkersTrace;
exports.currentUserConfig = currentUserConfig;
exports.currentUserTrace = currentUserTrace;
exports.CurrentUser = CurrentUser;
exports.CurrentUserTrace = CurrentUserTrace;
exports.ActionsHeatmap = ActionsHeatmap;
exports.ActionsHeatmapTrace = ActionsHeatmapTrace;
exports.StopsHeatmap = StopsHeatmap;
exports.StopsHeatmapTrace = StopsHeatmapTrace;
exports.ActionsCluster = ActionsCluster;
exports.ActionsClusterTrace = ActionsClusterTrace;
exports.DestinationMap = DestinationMap;
exports.DestinationMarker = DestinationMarker;
...
exports.ClusterMixin = ClusterMixin;
exports.DataObservableMixin = DataObservableMixin;
exports.DivMarkersMixin = DivMarkersMixin;
exports.ExtendBoundsMixin = ExtendBoundsMixin;
exports.HeatmapMixin = HeatmapMixin;
exports.MarkersMixin = MarkersMixin;
exports.PolylinesMixin = PolylinesMixin;
exports.PopupMixin = PopupMixin;
exports.SingleItemMixin = SingleItemMixin;
exports.StyleMixin = StyleMixin;
exports.TraceMixin = TraceMixin;
exports.ActionMap = ActionMap;
exports.ActionTrace = ActionTrace;
