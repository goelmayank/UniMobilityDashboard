...
import { IAction, HtPosition } from "ht-models";
...
import { IFollower } from "../mixins/follower";
import { HtCustomEvent, IEventSub } from "ht-utility";
export declare class StartMarker implements IFollower {
    mapInstance: MapInstance;
    name: string;
    constructor(mapInstance: any);
    styleFunct: StyleFunct;
    trace(mapItem: any): void;
    getPosition(data: IAction): HtPosition;
    getDivContent(): string;
}
export declare const StartMarkerTrace: {
    new (...args: any[]): {
        entities: {
