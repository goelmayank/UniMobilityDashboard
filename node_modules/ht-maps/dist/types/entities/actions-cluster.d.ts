...
export declare class ActionsCluster {
    mapInstance: MapInstance;
    styleFunct: StyleFunct;
    constructor(mapInstance: MapInstance);
    getPosition(data: any): HtPosition;
    getDivContent(action: any): string;
    getInfoContent(item: any): string;
    traceEffect(): void;
}
export declare const ActionsClusterTrace: {
    new (...args: any[]): {
    ...
    new (...arg: any[]): {
        ...
        onMouseEnter(entity: Entity<any>): void;
        onMouseLeave(entity: Entity<any>): void;
        getStyle: (styleType?: any, fallbackStyle?: any) => object;
        entities: {
            [id: string]: Entity<any>;
        };
        getPosition: (data: any) => HtPosition;
        getInfoContent: (data: any) => string;
        mapInstance: MapInstance;
