...
import { ItemClassFactoryConfig } from "../base/map-items-factory";
import { MapInstance } from "../map-utils/map-instance";
import { TimeAwareAnimation } from "time-aware-polyline";
import { IPathBearingTime } from "ht-models";
import { HtCustomEvent, IEventSub } from "ht-utility";
export declare const currentUserConfig: ItemClassFactoryConfig;
export declare const currentUserTrace: () => any;
...
export declare const CurrentUserTrace: {
    new (...args: any[]): {
        isAnimated: boolean;
